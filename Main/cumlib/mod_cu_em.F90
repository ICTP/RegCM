...
module mod_cu_em
  ...
  subroutine allocate_mod_cu_em
    ...
    call getmem(cbmf2d,jci1,jci2,ici1,ici2,'emanuel:cbmf2d')

    call getmem(imap,1,ncp,'emanuel:imap')
    call getmem(jmap,1,ncp,'emanuel:jmap')
    call getmem(ldmsk,1,ncp,'emanuel:ldmsk')
    call getmem(cbmf,1,ncp,'emanuel:cbmf')
    call getmem(pret,1,ncp,'emanuel:pret')
    call getmem(qprime,1,ncp,'emanuel:qprime')
    call getmem(tprime,1,ncp,'emanuel:tprime')
    call getmem(wd,1,ncp,'emanuel:wd')
    call getmem(elcrit,1,ncp,'emanuel:elcrit')
    call getmem(epmax,1,ncp,'emanuel:epmax')
    call getmem(iflag,1,ncp,'emanuel:iflag')
    call getmem(kbase,1,ncp,'emanuel:kbase')
    call getmem(ktop,1,ncp,'emanuel:ktop')
    call getmem(fq,1,ncp,1,kz,'emanuel:fq')
    call getmem(ft,1,ncp,1,kz,'emanuel:ft')
    call getmem(fu,1,ncp,1,kz,'emanuel:fu')
    call getmem(fv,1,ncp,1,kz,'emanuel:fv')
    call getmem(pcup,1,ncp,1,kz,'emanuel:pcup')
    call getmem(phcup,1,ncp,1,kzp1,'emanuel:phcup')
    call getmem(qcup,1,ncp,1,kz,'emanuel:qcup')
    call getmem(qscup,1,ncp,1,kz,'emanuel:qscup')
    call getmem(tcup,1,ncp,1,kz,'emanuel:tcup')
    call getmem(ucup,1,ncp,1,kz,'emanuel:ucup')
    call getmem(vcup,1,ncp,1,kz,'emanuel:vcup')
    call getmem(zcup,1,ncp,1,kz,'emanuel:zcup')
    call getmem(cldfra,1,ncp,1,kz,'emanuel:cldfra')
    call getmem(ppcp,1,ncp,1,kz,'emanuel:ppcp')
    if ( ichem == 1 ) then
