module mod_clm_mkarbinit
  ...
  subroutine mkarbinit()
    ...
    do c = begc , endc
      ...
      ! Note: Glacier_mec columns are initialized with half the maximum
      ! snow cover.  This gives more realistic values of qflx_glcice sooner
      ! in the simulation for columns with net ablation, at the cost of
