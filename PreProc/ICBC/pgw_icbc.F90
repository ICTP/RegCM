...
!
  ...
  call getmem(plev,1,npgwlev,'pgw_icbc:plev')
  call getmem(bps,1,jx,1,iy,'pgw_icbc:bps')
  call getmem(ps1,1,jx,1,iy,'pgw_icbc:ps1')
  call getmem(ps2,1,jx,1,iy,'pgw_icbc:ps2')
  call getmem(ps3,1,jx,1,iy,'pgw_icbc:ps3')
  call getmem(bts,1,jx,1,iy,'pgw_icbc:bts')
  call getmem(ts1,1,jx,1,iy,'pgw_icbc:ts1')
  call getmem(ts2,1,jx,1,iy,'pgw_icbc:ts2')
  call getmem(ts3,1,jx,1,iy,'pgw_icbc:ts3')
  call getmem(bu,1,jx,1,iy,1,npgwlev,'pgw_icbc:bu')
  call getmem(u1,1,jx,1,iy,1,npgwlev,'pgw_icbc:u1')
  call getmem(u2,1,jx,1,iy,1,npgwlev,'pgw_icbc:u2')
  call getmem(u3,1,jx,1,iy,1,npgwlev,'pgw_icbc:u3')
  call getmem(bv,1,jx,1,iy,1,npgwlev,'pgw_icbc:bv')
  call getmem(v1,1,jx,1,iy,1,npgwlev,'pgw_icbc:v1')
  call getmem(v2,1,jx,1,iy,1,npgwlev,'pgw_icbc:v2')
  call getmem(v3,1,jx,1,iy,1,npgwlev,'pgw_icbc:v3')
  call getmem(bt,1,jx,1,iy,1,npgwlev,'pgw_icbc:bt')
  call getmem(t1,1,jx,1,iy,1,npgwlev,'pgw_icbc:t1')
  call getmem(t2,1,jx,1,iy,1,npgwlev,'pgw_icbc:t2')
  call getmem(t3,1,jx,1,iy,1,npgwlev,'pgw_icbc:t3')
  call getmem(bq,1,jx,1,iy,1,npgwlev,'pgw_icbc:bq')
  call getmem(q1,1,jx,1,iy,1,npgwlev,'pgw_icbc:q1')
  call getmem(q2,1,jx,1,iy,1,npgwlev,'pgw_icbc:q2')
  call getmem(q3,1,jx,1,iy,1,npgwlev,'pgw_icbc:q3')
  call getmem(bias,1,jx,1,iy,1,kz,'pgw_icbc:bias')

  call getmem(sigma,1,kz,'pgw_icbc:sigma')
  call getmem(topo,1,jx,1,iy,'pgw_icbc:topo')
  call getmem(ps,1,jx,1,iy,'pgw_icbc:ps')
  call getmem(ts,1,jx,1,iy,'pgw_icbc:ts')
  call getmem(u,1,jx,1,iy,1,kz,'pgw_icbc:u')
  call getmem(v,1,jx,1,iy,1,kz,'pgw_icbc:v')
  call getmem(t,1,jx,1,iy,1,kz,'pgw_icbc:t')
  call getmem(q,1,jx,1,iy,1,kz,'pgw_icbc:q')
  if ( idynamic == 1 ) then
    call getmem(sigmar,1,npgwlev,'pgw_icbc:sigmar')
    call getmem(pd,1,jx,1,iy,'pgw_icbc:pd')
  end if
  if ( idynamic == 2 ) then
    call getmem(zsig,1,npgwlev,'pgw_icbc:zsig')
