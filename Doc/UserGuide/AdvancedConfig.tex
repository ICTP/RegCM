...
!
 ...
 enable_atm_vars = 72*.true., ! Mask to eventually disable variables ATM
 enable_srf_vars = 64*.true., ! Mask to eventually disable variables SRF
 enable_rad_vars = 33*.true., ! Mask to eventually disable variables RAD
 enable_sub_vars = 19*.true., ! Mask to eventually disable variables SUB
 enable_sts_vars = 20*.true., ! Mask to eventually disable variables STS
...
\begin{Verbatim}
 ...
 icldfrac =          0, ! Cloud fraction algorithm
                        ...
                        !   2 : Digital : cloud/no cloud on total condensate
