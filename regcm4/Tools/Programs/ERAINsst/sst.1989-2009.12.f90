 ...
 !     netCDF file 'sst.1989-2009.12.nc' into memory.
 !  
 !  History: 
 !  Date       Name          Action
 !-------------------------------------------------------
 ...
 ! Open netCDF file.
       ...
       xscale=0.000605914470935955
       xadd  =288.189457562092
 ...
 !  Begin writing statements to use the data.
      open(20,file='sst_12.dat',form='unformatted',recl=240*121*4,access='direct')
      do n=1,nrec
         do j=1,121
         do i=1,240
