...
module mod_sound
  ...
  subroutine allocate_mod_sound
    ...
    call getmem(rhs,jci1,jci2,ici1,ici2,2,kz,'sound:rhs')
    call getmem(sigdot,jci1,jci2,ici1,ici2,1,kzp1,'sound:sigdot')
    call getmem(wo,jci1,jci2,ici1,ici2,1,kzp1,'sound:wo')
    call getmem(e,jci1ga,jci2ga,ici1ga,ici2ga,1,kz,'sound:e')
    call getmem(f,jci1,jci2,ici1,ici2,1,kz,'sound:f')
    call getmem(ca,jci1,jci2,ici1,ici2,2,kz,'sound:ca')
    call getmem(g1,jci1,jci2,ici1,ici2,2,kz,'sound:g1')
    call getmem(g2,jci1,jci2,ici1,ici2,2,kz,'sound:g2')
    call getmem(ptend,jci1,jci2,ici1,ici2,1,kz,'sound:ptend')
    call getmem(pxup,jci1,jci2,ici1,ici2,1,kz,'sound:pxup')
    call getmem(pyvp,jci1,jci2,ici1,ici2,1,kz,'sound:pyvp')
    call getmem(tk,jci1,jci2,ici1,ici2,1,kz,'sound:tk')
    call getmem(cc,jci1,jci2,ici1,ici2,1,kz,'sound:cc')
    call getmem(cdd,jci1,jci2,ici1,ici2,1,kz,'sound:cdd')
    call getmem(cj,jci1,jci2,ici1,ici2,1,kz,'sound:cj')
    call getmem(pi,jci1,jci2,ici1,ici2,1,kz,'sound:pi')
    if ( ifupr == 1 ) then
      call getmem(astore,jci1,jci2,ici1,ici2,'sound:astore')
      call getmem(estore,jce1,jce2,ice1,ice2,'storage:estore')
      call getmem(estore_g,jcross1,jcross2, &
                             icross1,icross2,'storage:estore_g')
    end if
    call getmem(wpval,jci1,jci2,ici1,ici2,'sound:wpval')
    call getmem(rpsb,jce1,jce2,ice1,ice2,'sound:rpsb')
    call getmem(ucrs,jci1,jci2,ici1,ici2,1,kz,'sound:ucrs')
    call getmem(vcrs,jci1,jci2,ici1,ici2,1,kz,'sound:vcrs')
