...
! !USES:
  ...
  use mod_mpmessage
  use mod_clm_type
  use mod_clm_varpar  , only : maxpatch_pft, nlevsno, nlevgrnd, numrad, nlevlak, &
...
!------------------------------------------------------------------------
   ...
   ! and vertical profiles for calculating fluxes
    ...
    pps%fsun_z(beg:end,:nlevcan) = 0.D0
    pps%tlai(beg:end) = 0.D0
    pps%tsai(beg:end) = 0.D0
    pps%elai(beg:end) = 0.D0
    pps%tlai_z(beg:end,:nlevcan) = 0.D0
    pps%tsai_z(beg:end,:nlevcan) = 0.D0
    pps%esai(beg:end) = 0.D0
    pps%ncan(beg:end) = 0
    pps%nrad(beg:end) = 0
    pps%fwet(beg:end) = nan
    pps%fdry(beg:end) = nan
    pps%dt_veg(beg:end) = nan
    pps%htop(beg:end) = 0.D0
    pps%hbot(beg:end) = 0.D0
    pps%z0m(beg:end) = nan
    ...
    pps%fabd_sun_z(beg:end,:nlevcan) = 0.D0
    pps%fabd_sha_z(beg:end,:nlevcan) = 0.D0
    pps%fabi_sun_z(beg:end,:nlevcan) = 0.D0
    pps%fabi_sha_z(beg:end,:nlevcan) = 0.D0
    pps%u10(beg:end) = nan
    ...
    if ( crop_prog )then
       ...
       pps%htmx(beg:end)        = 0.0D0
       pps%vf(beg:end)          = 0.0D0
...
!------------------------------------------------------------------------
    ...
    pwf%qflx_evap_grnd(beg:end) = 0.0D0
    pwf%qflx_dew_grnd(beg:end) = 0.0D0
    pwf%qflx_sub_snow(beg:end) = 0.0D0
    pwf%qflx_dew_snow(beg:end) = 0.0D0
...
!   cps%xirrig(beg:end) = 0.D0
    ...
    cps%trotr1_col(beg:end) = 0.D0
    cps%trotr2_col(beg:end) = 0.D0
    cps%dtrotr_col(beg:end) = 0.D0
    cps%prec10_col(beg:end) = nan
    cps%prec60_col(beg:end) = nan
    cps%lfc(beg:end) = spval
    cps%lfc2(beg:end) = 0.D0
...
! New variable for methane
    ...
    cps%frac_h2osfc_temp(beg:end) = 0.0D0
...
!------------------------------------------------------------------------
    ...
    gwf%qflx_runoffg(beg:end) = 0.D0
    gwf%qflx_snwcp_iceg(beg:end) = 0.D0
