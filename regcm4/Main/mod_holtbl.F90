        ...
        if ( j.eq.2 ) then
          ...
          do k = 1 , kz
            do i = 2 , iym1
              ...
              idxm1 = max0(idxm1,2)
              if ( k.gt.1 )                                             &
                 & betak(i,k) = 0.5*(akzz1(idx,k,jm1)+                  &
                 &                   akzz1(idxm1,k,jm1))
              alphak(i,k) = 0.5*(akzz2(idx,k,jm1)+akzz2(idxm1,k,jm1))
            end do
          end do
        else
#endif
         do k = 1 , kz
           do i = 2 , iym1
             ...
             idxm1 = max0(idxm1,2)
             if ( k.gt.1 )                                             &
                & betak(i,k) = 0.25*(akzz1(idx,k,jm1)+                 &
                &                    akzz1(idxm1,k,jm1)+               &
                &                    akzz1(idx,k,j)+akzz1(idxm1,k,j))
             alphak(i,k) = 0.25*(akzz2(idx,k,jm1)+akzz2(idxm1,k,jm1)+  &
