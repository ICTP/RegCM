 ...
 !     netCDF file 'GTOPO30_5MIN.CDF' into memory.
 !  
 !  History: 
 !  Date       Name          Action
 !-------------------------------------------------------
 ...
 !     Below   5 variables is the data in netCDF file
      ...
      real*4         :: lat(          2160 )
      real*8         :: time(nrec)
      integer*2      ::  HT( 4320, 2160,nrec)
      integer*2      ::  HTSD( 4320, 2160,nrec)
      character*2    ::  a(4320,2160),char_2
      integer*1      :: I1
 ...
 ! Open netCDF file.
       status=nf_open('GTOPO30_5MIN.CDF',nf_nowrite,ncid)
 ...
 !     Here write your own code please!
       open(20,file='HT_pal.dat',form='unformatted',recl=4320*2160*2,access='direct')
       do j=1,2160
       do i=1,4320
