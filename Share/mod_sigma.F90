  ...
  contains
    ...
    subroutine init_sigma(nk,dmax,dmin)
      ...
      if ( nk == 14 ) then      ! RegCM2
        ...
        sigma_coordinate(20) = 0.650_rkx
        sigma_coordinate(21) = 0.675_rkx
        sigma_coordinate(22) = 0.700_rkx
        sigma_coordinate(23) = 0.725_rkx
        sigma_coordinate(24) = 0.750_rkx
        sigma_coordinate(25) = 0.775_rkx
        sigma_coordinate(26) = 0.800_rkx
        sigma_coordinate(27) = 0.825_rkx
        sigma_coordinate(28) = 0.850_rkx
        sigma_coordinate(29) = 0.875_rkx
        sigma_coordinate(30) = 0.900_rkx
        sigma_coordinate(31) = 0.910_rkx
        sigma_coordinate(32) = 0.920_rkx
        sigma_coordinate(33) = 0.930_rkx
        sigma_coordinate(34) = 0.940_rkx
        sigma_coordinate(35) = 0.950_rkx
        sigma_coordinate(36) = 0.960_rkx
        sigma_coordinate(37) = 0.970_rkx
        sigma_coordinate(38) = 0.980_rkx
        sigma_coordinate(39) = 0.990_rkx
        sigma_coordinate(40) = 0.995_rkx
