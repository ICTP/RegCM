      ...
      do itr = 1 , ntr
        do k = kz , 1 , -1
          do i = 1 , iym2
            do j = 1 , jx
#ifdef MPP1
              fchem(j,i) = chia_io(i+1,k,j,itr)/psa_io(i+1,j)
#else
              fchem(j,i) = chia(i+1,k,j,itr)/psa(i+1,j)
#endif
            end do
          end do
          if ( iotyp.eq.1 ) then
...
!     optical properties of the tracer mixing (independant of ntr)
      ...
      do k = kz , 1 , -1
        do i = 1 , iym2
          do j = 1 , jx
#ifdef MPP1
            fchem(j,i) = aerext_io(i+1,k,j)
#else
            fchem(j,i) = aerext(i+1,k,j)
#endif
          end do
        end do
        if ( iotyp.eq.1 ) then
      ...
      do k = kz , 1 , -1
        do i = 1 , iym2
          do j = 1 , jx
#ifdef MPP1
            fchem(j,i) = aerssa_io(i+1,k,j)
#else
            fchem(j,i) = aerssa(i+1,k,j)
#endif
          end do
        end do
        if ( iotyp.eq.1 ) then
      ...
      do k = kz , 1 , -1
        do i = 1 , iym2
          do j = 1 , jx
#ifdef MPP1
            fchem(j,i) = aerasp_io(i+1,k,j)
#else
            fchem(j,i) = aerasp(i+1,k,j)
#endif
          end do
        end do
        if ( iotyp.eq.1 ) then
...
!       -------
        do i = 1 , iym2
          do j = 1 , jx
#ifdef MPP1
            fchem(j,i) = dtrace_io(i+1,j,itr)
#else
            fchem(j,i) = dtrace(i+1,j,itr)
#endif
          end do
        end do
        if ( iotyp.eq.1 ) then
...
!       mpd = 1.
        ...
        do i = 1 , iym2
          do j = 1 , jx
#ifdef MPP1
            fchem(j,i) = wdlsc_io(i+1,j,itr)*mpd
#else
            fchem(j,i) = wdlsc(i+1,j,itr)*mpd
#endif
          end do
        end do
        if ( iotyp.eq.1 ) then
...
!       --------
        do i = 1 , iym2
          do j = 1 , jx
#ifdef MPP1
            fchem(j,i) = wdcvc_io(i+1,j,itr)*mpd
#else
            fchem(j,i) = wdcvc(i+1,j,itr)*mpd
#endif
          end do
        end do
        if ( iotyp.eq.1 ) then
...
!       -------------
        do i = 1 , iym2
          do j = 1 , jx
#ifdef MPP1
            fchem(j,i) = ddsfc_io(i+1,j,itr)*mpd
#else
            fchem(j,i) = ddsfc(i+1,j,itr)*mpd
#endif
          end do
        end do
        if ( iotyp.eq.1 ) then
...
!----------------------
        do i = 1 , iym2
          do j = 1 , jx
#ifdef MPP1
            fchem(j,i) = wxsg_io(i+1,j,itr)*mpd
#else
            fchem(j,i) = wxsg(i+1,j,itr)*mpd
#endif
          end do
        end do
        if ( iotyp.eq.1 ) then
...
!----------------------
        do i = 1 , iym2
          do j = 1 , jx
#ifdef MPP1
            fchem(j,i) = wxaq_io(i+1,j,itr)*mpd
#else
            fchem(j,i) = wxaq(i+1,j,itr)*mpd
#endif
          end do
        end do
        if ( iotyp.eq.1 ) then
...
!----------------------
        do i = 1 , iym2
          do j = 1 , jx
#ifdef MPP1
            fchem(j,i) = cemtrac_io(i+1,j,itr)*mpd
#else
            fchem(j,i) = cemtrac(i+1,j,itr)*mpd
#endif
          end do
        end do
        if ( iotyp.eq.1 ) then
...
!----total aerosol TOA radiative forcing ( independant of the number of tracer)
      ...
      do i = 1 , iym2
        do j = 1 , jx
#ifdef MPP1
          fchem(j,i) = aertarf_io(i+1,j)
#else
          fchem(j,i) = aertarf(i+1,j)
#endif
        end do
      end do
      if ( iotyp.eq.1 ) then
      ...
      do i = 1 , iym2
        do j = 1 , jx
#ifdef MPP1
          fchem(j,i) = aersrrf_io(i+1,j)
#else
          fchem(j,i) = aersrrf(i+1,j)
#endif
        end do
      end do
      if ( iotyp.eq.1 ) then
      ...
      do i = 1 , iym2
        do j = 1 , jx
#ifdef MPP1
          fchem(j,i) = aertalwrf_io(i+1,j)
#else
          fchem(j,i) = aertalwrf(i+1,j)
#endif
        end do
      end do
      if ( iotyp.eq.1 ) then
      ...
      do i = 1 , iym2
        do j = 1 , jx
#ifdef MPP1
          fchem(j,i) = aersrlwrf_io(i+1,j)
#else
          fchem(j,i) = aersrlwrf(i+1,j)
#endif
        end do
      end do
      if ( iotyp.eq.1 ) then
