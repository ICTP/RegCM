...
!
    ...
    real(rkx) , pointer , dimension(:,:) :: cfc11 , cfc12 , ch4 , n2o , qnm , tnm
...
!
    ...
    integer(ik4) :: j , l
!
    data g1/0.0468556_rkx , 0.0397454_rkx , 0.0407664_rkx , 0.0304380_rkx , &
            0.0540398_rkx , 0.0321962_rkx/
    data g2/14.4832_rkx , 4.30242_rkx , 5.23523_rkx , 3.25342_rkx , &
             0.698935_rkx , 16.5599_rkx/
    data g3/26.1898_rkx , 18.4476_rkx , 15.3633_rkx , 12.1927_rkx , &
             9.14992_rkx , 8.07092_rkx/
    data g4/0.0261782_rkx , 0.0369516_rkx , 0.0307266_rkx , 0.0243854_rkx , &
            0.0182932_rkx , 0.0161418_rkx/
    data ab/3.0857e-2_rkx , 2.3524e-2_rkx , 1.7310e-2_rkx , 2.6661e-2_rkx , &
            2.8074e-2_rkx , 2.2915e-2_rkx/
    data bb/ -1.3512e-4_rkx , -6.8320e-5_rkx , -3.2609e-5_rkx , -1.0228e-5_rkx ,  &
             -9.5743e-5_rkx , -1.0304e-4_rkx/
    data abp/2.9129e-2_rkx , 2.4101e-2_rkx , 1.9821e-2_rkx , 2.6904e-2_rkx ,  &
             2.9458e-2_rkx , 1.9892e-2_rkx/
    data bbp/ -1.3139e-4_rkx , -5.5688e-5_rkx , -4.6380e-5_rkx , -8.0362e-5_rkx , &
              -1.0115e-4_rkx , -8.8061e-5_rkx/
!------------------------------------------------------------------
!
    do j = n1 , n2
      sqti = sqrt(to3co2(j))
...
!
    ...
    data f2/2.02493e11_rkx , 3.04286e11_rkx , 6.90698e11_rkx , 6.47333e11_rkx , &
            2.85744e10_rkx , 4.41862e11_rkx , 9.62780e10_rkx , 1.21618e11_rkx , &
            1.79905e11_rkx , 3.29029e11_rkx , 1.48294e11_rkx , 1.72315e11_rkx , &
