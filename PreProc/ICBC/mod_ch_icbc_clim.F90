...
module mod_ch_icbc_clim
  ...
  subroutine init_ch_icbc_clim(idate)
    ...
    call getmem(xps31,1,jx,1,iy,'mod_ch_icbc:xps31')
    call getmem(xps32,1,jx,1,iy,'mod_ch_icbc:xps32')
    call getmem(chv31,1,jx,1,iy,1,chilev,1,nchsp,'mod_ch_icbc:chv31')
    call getmem(chv32,1,jx,1,iy,1,chilev,1,nchsp,'mod_ch_icbc:chv32')
    call getmem(chv4_1,1,jx,1,iy,1,kz,1,nchsp,'mod_ch_icbc:chv4_1')
    call getmem(chv4_2,1,jx,1,iy,1,kz,1,nchsp,'mod_ch_icbc:chv4_2')
    call getmem(chv4_3,1,jx,1,iy,1,kz,1,nchsp,'mod_ch_icbc:chv4_2')
    ...
    call getmem(xps,1,chilon,1,chjlat,'mod_ch_icbc:xps')
