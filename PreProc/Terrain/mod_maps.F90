...
module mod_maps
  ...
  subroutine prepare_grid(jx,iy,kz,ntex,nsoil,idyn)
    ...
    call getmem(xlat,1,jx,1,iy,'maps:xlat')
    call getmem(xlon,1,jx,1,iy,'maps:xlon')
    call getmem(dlat,1,jx,1,iy,'maps:dlat')
    call getmem(dlon,1,jx,1,iy,'maps:dlon')
    call getmem(htgrid,1,jx,1,iy,'maps:htgrid')
    call getmem(dpth,1,jx,1,iy,'maps:dpth')
    call getmem(lndout,1,jx,1,iy,'maps:lndout')
    call getmem(mask,1,jx,1,iy,'maps:mask')
    call getmem(snowam,1,jx,1,iy,'maps:snowam')
    call getmem(smoist,1,jx,1,iy,'maps:smoist')
    call getmem(texout,1,jx,1,iy,'maps:texout')
    call getmem(frac_tex,1,jx,1,iy,1,ntex,'maps:frac_tex')
    call getmem(rmoist,1,jx,1,iy,1,nsoil,'maps:rmoist')
    call getmem(rts,1,jx,1,iy,1,nsoil,'maps:rts')
    if ( idyn == 2 ) then
      call getmem(ps0,1,jx,1,iy,'maps:ps0')
      call getmem(pr0,1,jx,1,iy,1,kz+1,'maps:pr0')
      call getmem(t0,1,jx,1,iy,1,kz+1,'maps:t0')
      call getmem(rho0,1,jx,1,iy,1,kz+1,'maps:rho0')
      call getmem(z0,1,jx,1,iy,1,kz+1,'maps:z0')
    end if
    if ( idyn == 3 ) then
      call getmem(zita,1,kz+1,'maps:zita')
      ...
      call getmem(vlon,1,jx,1,iy,'maps:vlon')
  ...
  subroutine prepare_subgrid(jxsg,iysg,kz,ntex,nsoil,idyn)
    ...
    call getmem(xlon_s,1,jxsg,1,iysg,'maps:xlon_s')
    call getmem(dlat_s,1,jxsg,1,iysg,'maps:dlat_s')
    call getmem(dlon_s,1,jxsg,1,iysg,'maps:dlon_s')
    call getmem(htgrid_s,1,jxsg,1,iysg,'maps:htgrid_s')
    call getmem(dpth_s,1,jxsg,1,iysg,'maps:dpth_s')
    call getmem(lndout_s,1,jxsg,1,iysg,'maps:lndout_s')
    call getmem(mask_s,1,jxsg,1,iysg,'maps:mask_s')
    call getmem(snowam_s,1,jxsg,1,iysg,'maps:snowam_s')
    call getmem(smoist_s,1,jxsg,1,iysg,'maps:smoist_s')
    call getmem(texout_s,1,jxsg,1,iysg,'maps:texout_s')
    call getmem(frac_tex_s,1,jxsg,1,iysg,1,ntex,'maps:frac_tex_s')
    call getmem(rmoist_s,1,jxsg,1,iysg,1,nsoil,'maps:rmoist_s')
    call getmem(rts_s,1,jxsg,1,iysg,1,nsoil,'maps:rts_s')
    if ( idyn == 2 ) then
      call getmem(ps0_s,1,jxsg,1,iysg,'maps:ps0_s')
      call getmem(pr0_s,1,jxsg,1,iysg,1,kz+1,'maps:pr0_s')
      call getmem(t0_s,1,jxsg,1,iysg,1,kz+1,'maps:t0_s')
      call getmem(rho0_s,1,jxsg,1,iysg,1,kz+1,'maps:rho0_s')
      call getmem(z0_s,1,jxsg,1,iysg,1,kz+1,'maps:z0_s')
    end if
    if ( idyn == 3 ) then
      ...
      call getmem(vlon_s,1,jxsg,1,iysg,'maps:vlon_s')
