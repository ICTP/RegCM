 ...
 !     netCDF file 'tskin.1989-2009.00.nc' into memory.
 !  
 !  History: 
 !  Date       Name          Action
 !-------------------------------------------------------
 ...
 ! Open netCDF file.
       status=nf_open('/media/disk/RCM_DATA/ERAIN150/tskin.1989-2009.00.nc',nf_nowrite,ncid)
       xscale=0.00248069392960274
       xadd  =253.471373371012
 ...
 !  Begin writing statements to use the data.
      open(20,file='tskin_00.dat',form='unformatted',recl=240*121*4,access='direct')
      do n=1,nrec
         do j=1,121
         do i=1,240
