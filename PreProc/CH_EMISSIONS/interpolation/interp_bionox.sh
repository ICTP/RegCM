...
function emissions_interpolate
{
    ...
    $CDO gencon,$REGCM_dir/${DOMNAME}_grid.nc -setgrid,${data_dir}/Global_soilpH2.nc \
	${data_dir}/Global_soilpH2.nc remapweights.nc
    $CDO -O $CDOOPTIONS remap,$REGCM_dir/${DOMNAME}_grid.nc,remapweights.nc ${data_dir}/Global_soilpH2.nc $REGCM_dir/${DOMNAME}_BIONOX_TMP1.nc


    $CDO gencon,$REGCM_dir/${DOMNAME}_grid.nc -setgrid,${data_dir}/Nfert.nc \
        ${data_dir}/Nfert.nc remapweights.nc
    $CDO -O $CDOOPTIONS remap,$REGCM_dir/${DOMNAME}_grid.nc,remapweights.nc ${data_dir}/Nfert.nc $REGCM_dir/${DOMNAME}_BIONOX_TMP2.nc

    $CDO gencon,$REGCM_dir/${DOMNAME}_grid.nc -setgrid,${data_dir}/Nmanure.nc \
        ${data_dir}/Nmanure.nc remapweights.nc
    $CDO -O $CDOOPTIONS remap,$REGCM_dir/${DOMNAME}_grid.nc,remapweights.nc ${data_dir}/Nmanure.nc $REGCM_dir/${DOMNAME}_BIONOX_TMP3.nc

        
    # merge averything
    $CDO $CDOOPTIONS  merge $REGCM_dir/${DOMNAME}_BIONOX_TMP*.nc $REGCM_dir/${DOMNAME}_BIONEM.nc
