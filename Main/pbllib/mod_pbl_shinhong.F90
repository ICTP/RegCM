...
module mod_pbl_shinhong
  ...
  subroutine init_shinhong_pbl( )
    ...
    call getmem(th2d,1,numbl,1,kz,'shinhong_pbl')
    call getmem(p2d,1,numbl,1,kz,'shinhong_pbl')
    call getmem(dz2d,1,numbl,1,kz,'shinhong_pbl')
    call getmem(pi2d,1,numbl,1,kz,'shinhong_pbl')
    call getmem(p2di,1,numbl,1,kzp1,'shinhong_pbl')
    call getmem(tke2d,1,numbl,1,kz,'shinhong_pbl')
    call getmem(qtrac,1,numbl,1,kz*ndiff,'shinhong_pbl')
    call getmem(utnp,1,numbl,1,kz,'shinhong_pbl')
    call getmem(vtnp,1,numbl,1,kz,'shinhong_pbl')
    call getmem(ttnp,1,numbl,1,kz,'shinhong_pbl')
    call getmem(qtnp,1,numbl,1,kz*ndiff,'shinhong_pbl')
    call getmem(psfc,1,numbl,'shinhong_pbl')
    call getmem(hfx,1,numbl,'shinhong_pbl')
    call getmem(qfx,1,numbl,'shinhong_pbl')
    call getmem(ust,1,numbl,'shinhong_pbl')
    ...
    call getmem(dvsfc,1,numbl,'shinhong_pbl')
    call getmem(dtsfc,1,numbl,'shinhong_pbl')
    call getmem(dqsfc,1,numbl,'shinhong_pbl')
    call getmem(wstar,1,numbl,'shinhong_pbl')
    call getmem(delta,1,numbl,'shinhong_pbl')
  ...
  subroutine shinhong2d(nbl,ux,vx,tx,qx,p2d,p2di,pi2d,utnp,vtnp,ttnp,qtnp, &
    ...
    real(rkx), dimension(nbl), intent(out) :: dtsfc, dqsfc, dusfc, dvsfc
    ...
    real(rkx), dimension(nbl) :: phim, phih
    real(rkx), dimension(nbl) :: prpbl, wspd1
