 ...
 !     netCDF file 'GTOPO30_10MIN.CDF' into memory.
 !  
 !  History: 
 !  Date       Name          Action
 !-------------------------------------------------------
 ...
 !     Below   5 variables is the data in netCDF file
      ...
      real*4         :: lat(          1080 )
      real*8         :: time(nrec)
      integer*2      ::  HT( 2160, 1080,nrec)
      integer*2      ::  HTSD( 2160, 1080,nrec)
      character*2    ::  a(2160,1080),char_2
      integer*1      :: I1
 ...
 ! Open netCDF file.
       status=nf_open('GTOPO30_10MIN.CDF',nf_nowrite,ncid)
 ...
 !     Here write your own code please!
       open(20,file='HT_pal.dat',form='unformatted',recl=2160*1080*2,access='direct')
       do j=1,1080
       do i=1,2160
