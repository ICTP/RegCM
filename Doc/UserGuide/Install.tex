...
on your working directory a new directory, named \verb=RegCM-4.2=.
...
The RegCM Version 4.2 is configured by a python2 script, which will select
...
\begin{enumerate}
\item Linux with GNU gfortran compiler version $\ge 4.5$
...
The 4.2 version of the RegCM model relies on the standard GNU autotools to
...
area not going round the whole earth.
