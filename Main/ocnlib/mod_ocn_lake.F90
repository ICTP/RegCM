...
module mod_ocn_lake
  ...
  real(rkx), pointer, contiguous, dimension(:,:) :: tlak => null( )
  real(rkx), pointer, contiguous, dimension(:) :: hi => null( )
  real(rkx), pointer, contiguous, dimension(:) :: eta => null( )
  logical, pointer, contiguous, public, dimension(:) :: lakmsk => null( )
  integer(ik4), pointer, contiguous, dimension(:) :: idep => null( )
  integer(ik4), pointer, contiguous, dimension(:) :: ilp => null( )
