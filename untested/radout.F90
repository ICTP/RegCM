...
!::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
      ...
      subroutine radout(solin,sabtp,frsa,clrst,clrss,qrs,firtp,frla,    &
                      & clrlt,clrls,qrl,slwd,srfrad,sols,soll,solsd,    &
                      & solld,alb,albc,fsds,fsnirt,fsnrtc,fsnirtsq,jslc,&
                      & h2ommr,cld,clwp)
!
...
!
      ...
      real(8) , dimension(ixm1) :: alb , albc , clrls , clrlt , clrss ,&
                                  ...
                                  & solsd , srfrad
      real(8) , dimension(ixm1,kx) :: cld , clwp , h2ommr , qrl , qrs
