...
module mod_scrip_remap_vars
  ...
  integer(rk4) , dimension(:) , allocatable , public :: &
  ...
  public :: init_remap_vars , resize_remap_vars
...
end module mod_scrip_remap_vars
