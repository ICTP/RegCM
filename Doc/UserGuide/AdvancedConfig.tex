...
in the case of the band, and is named \verb=regcmMPI_band=.
...
\ref{geoparam} is mostly ignored,
as the projection is set to Normal Mercator, and the grid point resolution is
calculated as
