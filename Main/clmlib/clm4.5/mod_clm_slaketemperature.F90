...
! !ARGUMENTS:
    ...
    integer(ik4) , intent(in)  :: num_lakec                      ! number of column lake points in column filter
    integer(ik4) , intent(in)  :: filter_lakec(ubc-lbc+1)        ! column filter for lake points
