...
!
  ...
  subroutine allocate_mod_cu_bm
    ...
    call getmem(tds,1,kz,'cu_bm:tds')
    call getmem(apesk,1,kz,'cu_bm:apesk')
    call getmem(difq,1,kz,'cu_bm:difq')
    call getmem(dift,1,kz,'cu_bm:dift')
    call getmem(fpk,1,kz,'cu_bm:fpk')
    call getmem(pdp,1,kz,'cu_bm:pdp')
    call getmem(pk,1,kz,'cu_bm:pk')
    call getmem(psk,1,kz,'cu_bm:psk')
    call getmem(qk,1,kz,'cu_bm:qk')
    call getmem(qrefk,1,kz,'cu_bm:qrefk')
    call getmem(qsatk,1,kz,'cu_bm:qsatk')
    call getmem(therk,1,kz,'cu_bm:therk')
    call getmem(thsk,1,kz,'cu_bm:thsk')
    call getmem(thvref,1,kz,'cu_bm:thrvref')
    call getmem(tk,1,kz,'cu_bm:tk')
    call getmem(trefk,1,kz,'cu_bm:trefk')
    call getmem(kdp,1,kz,'cu_bm:kdp')
    call getmem(ape,jci1,jci2,ici1,ici2,1,kz,'cu_bm:ape')
    call getmem(q,jci1,jci2,ici1,ici2,1,kz,'cu_bm:q')
    call getmem(qqmod,jci1,jci2,ici1,ici2,1,kz,'cu_bm:qqmod')
    call getmem(t,jci1,jci2,ici1,ici2,1,kz,'cu_bm:t')
    call getmem(tmod,jci1,jci2,ici1,ici2,1,kz,'cu_bm:tmod')
    call getmem(tref,jci1,jci2,ici1,ici2,1,kz,'cu_bm:tref')
    call getmem(z0,jci1,jci2,ici1,ici2,1,kz,'cu_bm:z0')
    call getmem(ifbuoy,jci1,jci2,ici1,ici2,'cu_bm:ifbuoy')
    call getmem(ml,jci1,jci2,ici1,ici2,'cu_bm:ml')
    call getmem(cldhgt,jci1,jci2,ici1,ici2,'cu_bm:cldhgt')
    call getmem(dsp0,jci1,jci2,ici1,ici2,'cu_bm:dsp0')
    call getmem(dspb,jci1,jci2,ici1,ici2,'cu_bm:dspb')
    call getmem(dspt,jci1,jci2,ici1,ici2,'cu_bm:dspt')
    call getmem(psp,jci1,jci2,ici1,ici2,'cu_bm:psp')
    call getmem(xsm,jci1,jci2,ici1,ici2,'cu_bm:xsm')
    call getmem(thbt,jci1,jci2,ici1,ici2,'cu_bm:thbt')
    call getmem(thesp,jci1,jci2,ici1,ici2,'cu_bm:thesp')
    call getmem(ths,jci1,jci2,ici1,ici2,'cu_bm:ths')
    call getmem(tthbt,jci1,jci2,ici1,ici2,'cu_bm:tthbt')
    call getmem(tthes,jci1,jci2,ici1,ici2,'cu_bm:tthes')
    intall = (jci2-jci1+1)*(ici2-ici1+1)
    call getmem(ideep,1,intall,'cu_bm:ideep')
