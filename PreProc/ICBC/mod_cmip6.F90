      ...
      if ( dattyp == 'PMIP4' ) then
        select case (pmip4_model)
          case ( 'MPI-ESM1-2-LR' )
            ...
            call getmem3d(pa_in,1,ta%ni,1,ta%nj,1,ta%nk,'pmip4:mpilr:pa_in')
            call getmem3d(zp_in,1,ta%ni,1,ta%nj,1,ta%nk,'pmip4:mpilr:zp_in')
            call getmem3d(tvar,1,ta%ni,1,ta%nj,1,nkin,'pmip4:mpilr:tvar')
            call getmem3d(uvar,1,ua%ni,1,ua%nj,1,nkin,'pmip4:mpilr:uvar')
            call getmem3d(vvar,1,va%ni,1,va%nj,1,nkin,'pmip4:mpilr:vvar')
            call getmem3d(qvar,1,qa%ni,1,qa%nj,1,nkin,'pmip4:mpilr:qvar')
            call getmem3d(zvar,1,ta%ni,1,ta%nj,1,nkin,'pmip4:mpilr:zvar')
            call getmem3d(tah,1,jx,1,iy,1,nkin,'pmip4:mpilr:tah')
            call getmem3d(qah,1,jx,1,iy,1,nkin,'pmip4:mpilr:qah')
            call getmem3d(uah,1,jx,1,iy,1,nkin,'pmip4:mpilr:uah')
            call getmem3d(vah,1,jx,1,iy,1,nkin,'pmip4:mpilr:vah')
            call getmem3d(zgh,1,jx,1,iy,1,nkin,'pmip4:mpilr:zgh')
          case ( 'IPSL-CM6A-LR' )
            allocate(ps,ua,va,ta,qa,orog)
            ps%vname = 'ps'
            ua%vname = 'ua'
            ...
            pss = (fplev(1)-fplev(nkin))/10.0_rkx
            pst = fplev(nkin)/10.0_rkx
            call getmem3d(pa_in,1,ta%ni,1,ta%nj,1,ta%nk,'pmip4:ipsllr:pa_in')
            call getmem3d(zp_in,1,ta%ni,1,ta%nj,1,ta%nk,'pmip4:ipsllr:zp_in')
            call getmem3d(tvar,1,ta%ni,1,ta%nj,1,nkin,'pmip4:ipsllr:tvar')
            call getmem3d(uvar,1,ua%ni,1,ua%nj,1,nkin,'pmip4:ipsllr:uvar')
            call getmem3d(vvar,1,va%ni,1,va%nj,1,nkin,'pmip4:ipsllr:vvar')
            call getmem3d(qvar,1,qa%ni,1,qa%nj,1,nkin,'pmip4:ipsllr:qvar')
            call getmem3d(zvar,1,ta%ni,1,ta%nj,1,nkin,'pmip4:ipsllr:zvar')
            call getmem3d(tah,1,jx,1,iy,1,nkin,'pmip4:ipsllr:tah')
            call getmem3d(qah,1,jx,1,iy,1,nkin,'pmip4:ipsllr:qah')
            call getmem3d(uah,1,jx,1,iy,1,nkin,'pmip4:ipsllr:uah')
            call getmem3d(vah,1,jx,1,iy,1,nkin,'pmip4:ipsllr:vah')
            call getmem3d(zgh,1,jx,1,iy,1,nkin,'pmip4:ipsllr:zgh')
          case default
        ...
        select case (cmip6_model)
          case ( 'MPI-ESM1-2-LR' )
            ...
            pss = (fplev(1)-fplev(nkin))/10.0_rkx
            pst = fplev(nkin)/10.0_rkx
            call getmem3d(pa_in,1,ta%ni,1,ta%nj,1,ta%nk,'cmip6:mpilr:pa_in')
            call getmem3d(zp_in,1,ta%ni,1,ta%nj,1,ta%nk,'cmip6:mpilr:zp_in')
            call getmem3d(tvar,1,ta%ni,1,ta%nj,1,nkin,'cmip6:mpilr:tvar')
            call getmem3d(uvar,1,ua%ni,1,ua%nj,1,nkin,'cmip6:mpilr:uvar')
            call getmem3d(vvar,1,va%ni,1,va%nj,1,nkin,'cmip6:mpilr:vvar')
            call getmem3d(qvar,1,qa%ni,1,qa%nj,1,nkin,'cmip6:mpilr:qvar')
            call getmem3d(zvar,1,ta%ni,1,ta%nj,1,nkin,'cmip6:mpilr:zvar')
            call getmem3d(tah,1,jx,1,iy,1,nkin,'cmip6:mpilr:tah')
            call getmem3d(qah,1,jx,1,iy,1,nkin,'cmip6:mpilr:qah')
            call getmem3d(uah,1,jx,1,iy,1,nkin,'cmip6:mpilr:uah')
            call getmem3d(vah,1,jx,1,iy,1,nkin,'cmip6:mpilr:vah')
            call getmem3d(zgh,1,jx,1,iy,1,nkin,'cmip6:mpilr:zgh')
          case ( 'MPI-ESM1-2-HR' )
            allocate(ps,ua,va,ta,qa,orog)
            ps%vname = 'ps'
            ua%vname = 'ua'
          ...
          case ( 'CMCC-ESM2' )
            ...
            pss = (fplev(1)-fplev(nkin))/10.0_rkx
            pst = fplev(nkin)/10.0_rkx
            call getmem3d(pa_in,1,ta%ni,1,ta%nj,1,ta%nk,'cmip6:cmcc:pa_in')
            call getmem3d(zp_in,1,ta%ni,1,ta%nj,1,ta%nk,'cmip6:cmcc:zp_in')
            call getmem3d(tvar,1,ta%ni,1,ta%nj,1,nkin,'cmip6:cmcc:tvar')
            call getmem3d(uvar,1,ua%ni,1,ua%nj,1,nkin,'cmip6:cmcc:uvar')
            call getmem3d(vvar,1,va%ni,1,va%nj,1,nkin,'cmip6:cmcc:vvar')
            call getmem3d(qvar,1,qa%ni,1,qa%nj,1,nkin,'cmip6:cmcc:qvar')
            call getmem3d(zvar,1,ta%ni,1,ta%nj,1,nkin,'cmip6:cmcc:zvar')
            call getmem3d(tah,1,jx,1,iy,1,nkin,'cmip6:cmcc:tah')
            call getmem3d(qah,1,jx,1,iy,1,nkin,'cmip6:cmcc:qah')
            call getmem3d(uah,1,jx,1,iy,1,nkin,'cmip6:cmcc:uah')
            call getmem3d(vah,1,jx,1,iy,1,nkin,'cmip6:cmcc:vah')
            call getmem3d(zgh,1,jx,1,iy,1,nkin,'cmip6:cmcc:zgh')
          case ( 'NorESM2-MM' )
            allocate(ps,ua,va,ta,qa,orog)
            ps%vname = 'ps'
            ua%vname = 'ua'
