...
C ****** SET UP NetCDF STUFF
     ...
     &   , xlat,xlon,vvarmin,vvarmax,xlat1d,xlon1d,idim,ndim)
      ...
      sigf(2) = 1.
      sig1d(1) = 1.
      idatex0 = idatecru0*10000 + 1500
      idatex1 = idatecru1*10000 + 1500
      idatex2 = idatecru2*10000 + 1500
...
C ****** READ/WRITE DATA
     ...
     &       , vvarmin,vvarmax,xlat1d,xlon1d,sig1d,0,xmin)
          ...
          if (ifld.eq.10) idatex=idatex2+1  ! Elevation
          itim = itim + 1
          print*,idatex,idatex2
        end do
