...
on your working directory a new directory, named \verb=RegCM-4.3.x=.
...
\item netCDF (\cite{Rew_90}) Format I/O library compiled with the above
  ...
  {\bf http://www.unidata.ucar.edu/downloads/netcdf/netcdf-4\_2\_1\_1/ } \\
  {\bf http://www.unidata.ucar.edu/downloads/netcdf/netcdf-fortran} \\
\end{enumerate}
...
Note that current netCDF version 4.2.1.1 is dependent on HDF5 1.9.
...
The RegCM Version 4.3 is configured by a configure script, which will select
