...
! local pointers to implicit in arrays
   ...
   real(rk8), pointer :: nind(:)         ! number of individuals (#/m2) added by F. Li and S. Levis
#endif
!
...
! !OTHER LOCAL VARIABLES:
   ...
   real(rk8):: mort_max                  ! asymptotic max mortality rate (/yr)
   real(rk8), parameter :: k_mort = 0.3  !coeff of growth efficiency in mortality equation
