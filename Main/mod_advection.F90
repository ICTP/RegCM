...
module mod_advection
  ...
  contains
    ...
    subroutine init_advection
      ...
      call getmem(dds,1,kzp1,'mod_advection:dds')
      call getmem(xds,1,kz,'mod_advection:xds')
      call getmem(fg,jci1,jci2,ici1,ici2,1,kz,'advection:fg')
      call getmem(uavg1,jci1,jci2,ici1,ici2,1,kz,'advection:uavg1')
      call getmem(uavg2,jci1,jci2,ici1,ici2,1,kz,'advection:uavg2')
      call getmem(vavg1,jci1,jci2,ici1,ici2,1,kz,'advection:vavg1')
      call getmem(vavg2,jci1,jci2,ici1,ici2,1,kz,'advection:vavg2')
      xds(:) =  d_one / dsigma(:)
      dds(1) = d_zero
      dds(kzp1) = d_zero
      do k = 2, kz
