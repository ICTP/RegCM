...
module mod_outvars
  ...
  real(rk8) , dimension(:,:,:) , pointer :: atm_qr_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_qi_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_qs_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_rh_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_zf_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_zh_out => null()
  ...
  real(rk8) , dimension(:,:,:) , pointer :: atm_qten_adh_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_qten_adv_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_qten_tbl_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_qten_dif_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_qten_bdy_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_qten_con_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_qten_adi_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_qten_rad_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_qten_lsc_out => null()
...
! stats
  ...
  real(rk8) , dimension(:,:,:) , pointer :: atm_stats_detc_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_stats_erow_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_stats_eroc_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_stats_evw_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_stats_evc_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_stats_con1w_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_stats_con1c_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_stats_con2w_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_stats_con2c_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_stats_dep_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_stats_melt_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_stats_frz_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_stats_rainev_out => null()
  ...
  real(rk8) , dimension(:,:) , pointer :: opt_aastoarf_out => null()
  real(rk8) , dimension(:,:) , pointer :: opt_aastsrrf_out => null()
