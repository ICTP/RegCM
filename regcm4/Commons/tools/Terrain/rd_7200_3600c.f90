 ...
 !     netCDF file 'GTOPO30_3MIN.CDF' into memory.
 !  
 !  History: 
 !  Date       Name          Action
 !-------------------------------------------------------
 ...
 !     Below   5 variables is the data in netCDF file
      ...
      real*4         :: lat(          3600 )
      real*8         :: time(nrec)
      integer*2      ::  HT( 7200, 3600,nrec)
      integer*2      ::  HTSD( 7200, 3600,nrec)
      character*2    ::  a(7200,3600),char_2
      integer*1      :: I1
 ...
 ! Open netCDF file.
       status=nf_open('GTOPO30_3MIN.CDF',nf_nowrite,ncid)
 ...
 !     Here write your own code please!
       open(20,file='HT_pal.dat',form='unformatted',recl=7200*3600*2,access='direct')
       do j=1,3600
       do i=1,7200
