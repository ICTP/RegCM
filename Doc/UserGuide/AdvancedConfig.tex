...
\begin{Verbatim}
 ...
 nspgd  = 12, ! nspgd-1 represent the number of dot point slices on
              ! the boundary sponge or relaxation boundary conditions.
 high_nudge   =     1.0, ! Nudge value high range
 medium_nudge =     2.0, ! Nudge value medium range
 low_nudge    =     3.0  ! Nudge value low range
 /
\end{Verbatim}
}
...
\subsection{grellparam, emanparam and tiedtkeparam namelist}
...
\begin{Verbatim}
 ...
 lepcld = .true.,     ! true if prognostic cloud scheme is on (iconv=4)
 ...
 lmfuvdis = .true.,   ! true if use kinetic energy dissipation
 lmftrac = .true.,    ! true if chemical tracer transport is on
 lmfsmooth = .false., ! true if smoothing of mass fluxes top/bottom for tracers
 lmfwstar = .false.,  ! true if Grant w* closure for shallow convection
 ...
 rhcdd = 0.9D0,       ! Relative saturation in downdrafts
 cmtcape = 453600.D0, ! CAPE adjustment timescale parameter
 ...
 ctrigger = -1.1D0,   ! Trigger parameter for the convection 0.0 <-> 1.0
 ...
 rcpecons = 5.55D-5,  ! Coefficient for rain evaporation below cloud
 rtaumel = 27.0D3,    ! Relaxation time for melting of snow
 rhebc_lnd = 0.7D0,   ! Critical relative humidity below cloud for evaporation
 rhebc_ocn = 0.9D0,   ! Critical relative humidity below cloud for evaporation
