...
module mod_outvars
  ...
  real(rk8) , dimension(:,:,:) , pointer :: atm_qcrit_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_ccnnum_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_qincl_out => null()
  real(rk8) , dimension(:,:,:) , pointer :: atm_autoconvr_out => null()
