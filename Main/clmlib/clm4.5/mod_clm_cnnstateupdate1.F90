...
!
   ...
   real(rk8), pointer :: grainn_storage_to_xfer(:)       ! grain N shift storage to transfer (gN/m2/s)
   real(rk8), pointer :: grainn_to_food(:)               ! grain N to food (gN/m2/s)
   real(rk8), pointer :: grainn_xfer_to_grainn(:)        ! grain N growth from storage (gN/m2/s)
...
! local pointers to implicit in/out scalars
   ...
   real(rk8), pointer :: ndep_prof(:,:)                         ! profile over which N deposition is distributed through column (1/m)
   real(rk8), pointer :: nfixation_prof(:,:)                    ! profile over which N fixation is distributed through column (1/m)
...
! local pointers to implicit out scalars
   ...
   real(rk8), pointer :: pft_begnb(:)   ! nitrogen mass, beginning of time step (gN/m**2)
!
