...
!
 ...
 enable_srf_vars = 40*.true., ! Mask to eventually disable variables SRF
...
!
 ...
 gnu2 = 0.1250,  ! nu factor for Asselin filter in leapfrog step (tracers).
                 ! MM5 manual , equation 2.4.6
                 ! Default 0.0625,0.1 for hydro, 0.1,0.1 for nonhydro
 ...
 umax = 160.0,            ! Value of U for maximum off centering
 ...
 q_rel_extrema = 0.5, ! Maximum gradient fraction for QV for advection to stop
 c_rel_extrema = 0.5, ! Maximum gradient fraction for QX for advection to stop
 t_rel_extrema = 0.5, ! Maximum gradient fraction for tracer advection to stop
 /
\end{Verbatim}
}
