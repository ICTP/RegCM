...
! local pointers to implicit in scalars
   ...
   !!! C13
   real(rk8), pointer :: c13_col_ctrunc_vr(:,:)    ! (gC/m3) column-level sink for C truncation
   real(rk8), pointer :: decomp_c13pools_vr(:,:,:) ! (gC/m3)  vertically-resolved decomposing (litter, cwd, soil) c pools
   real(rk8), pointer :: c13_cpool(:)              ! (gC/m2) temporary photosynthate C pool
   real(rk8), pointer :: c13_deadcrootc(:)         ! (gC/m2) dead coarse root C
   real(rk8), pointer :: c13_deadcrootc_storage(:) ! (gC/m2) dead coarse root C storage
   real(rk8), pointer :: c13_deadcrootc_xfer(:)    ! (gC/m2) dead coarse root C transfer
   ...
   real(rk8), pointer :: c13_frootc_xfer(:)        ! (gC/m2) fine root C transfer
   ...
   real(rk8), pointer :: c13_livecrootc_storage(:) ! (gC/m2) live coarse root C storage
   real(rk8), pointer :: c13_livecrootc_xfer(:)    ! (gC/m2) live coarse root C transfer
   ...
   real(rk8), pointer :: c13_pft_ctrunc(:)         ! (gC/m2) pft-level sink for C truncation

   !!! C14
   real(rk8), pointer :: c14_col_ctrunc_vr(:,:)    ! (gC/m3) column-level sink for C truncation
   real(rk8), pointer :: decomp_c14pools_vr(:,:,:) ! (gC/m3)  vertically-resolved decomposing (litter, cwd, soil) c pools
   real(rk8), pointer :: c14_cpool(:)              ! (gC/m2) temporary photosynthate C pool
   real(rk8), pointer :: c14_deadcrootc(:)         ! (gC/m2) dead coarse root C
   real(rk8), pointer :: c14_deadcrootc_storage(:) ! (gC/m2) dead coarse root C storage
   real(rk8), pointer :: c14_deadcrootc_xfer(:)    ! (gC/m2) dead coarse root C transfer
   ...
   real(rk8), pointer :: c14_livecrootc_storage(:) ! (gC/m2) live coarse root C storage
   real(rk8), pointer :: c14_livecrootc_xfer(:)    ! (gC/m2) live coarse root C transfer
   ...
   real(rk8), pointer :: c14_pft_ctrunc(:)         ! (gC/m2) pft-level sink for C truncation
