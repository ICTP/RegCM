module seq_flds_mod
   ...
   character(*), parameter :: seq_flds_x2a_states = &
      ...
      //':Si_avsdr'    &    ! albedo, visible, direct         GENSOM
      //':Si_anidr'    &    ! albedo, near-ir, direct         GENSOM
      //':Si_avsdf'    &    ! albedo, visible, diffuse        GENSOM
      //':Si_anidf'    &    ! albedo, near-ir, diffuse        GENSOM
      //':So_avsdr'    &    ! albedo, visible, direct         GENSOM
      //':So_anidr'    &    ! albedo, near-ir, direct         GENSOM
      //':So_avsdf'    &    ! albedo, visible, diffuse        GENSOM
      //':So_anidf'         ! albedo, near-ir, diffuse        GENSOM
   ...
   character(*), parameter :: seq_flds_x2a_fluxes = &
      ...
      //':Faii_lat'    &    ! latent          heat flux       GENSOM
      //':Faox_lat'    &    ! latent          heat flux       GENSOM
      //':Faii_sen'    &    ! sensible        heat flux       GENSOM
      //':Faox_sen'    &    ! sensible        heat flux       GENSOM
      //':Faii_lwup'   &    ! upward longwave heat flux       GENSOM
      //':Faox_lwup'        ! upward longwave heat flux       GENSOM
