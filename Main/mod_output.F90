...
!
      ...
      call subgrid_collect(tgbrd,tgbrd_io,jce1,jce2,ice1,ice2)
      call subgrid_collect(tsw,tsw_io,jce1,jce2,ice1,ice2)
      call subgrid_collect(ldmsk1,ldmsk1_io,jce1,jce2,ice1,ice2)
!
!=======================================================================
...
!
  if ( ifsave ) then
    if ( ldosav .or. ldotmp ) then
      ...
      call subgrid_collect(tlef,tlef_io,jce1,jce2,ice1,ice2)
      call subgrid_collect(ssw,ssw_io,jce1,jce2,ice1,ice2)
      call subgrid_collect(rsw,rsw_io,jce1,jce2,ice1,ice2)
      call subgrid_collect(tgrd,tgrd_io,jce1,jce2,ice1,ice2)
      call subgrid_collect(tgbrd,tgbrd_io,jce1,jce2,ice1,ice2)
      call subgrid_collect(sncv,sncv_io,jce1,jce2,ice1,ice2)
      call subgrid_collect(gwet,gwet_io,jce1,jce2,ice1,ice2)
      call subgrid_collect(snag,snag_io,jce1,jce2,ice1,ice2)
      call subgrid_collect(sfice,sfice_io,jce1,jce2,ice1,ice2)
      call subgrid_collect(ldew,ldew_io,jce1,jce2,ice1,ice2)
      call subgrid_collect(taf,taf_io,jce1,jce2,ice1,ice2)
      call subgrid_collect(tsw,tsw_io,jce1,jce2,ice1,ice2)
      call subgrid_collect(emiss,emiss_io,jce1,jce2,ice1,ice2)
      call subgrid_collect(ldmsk1,ldmsk1_io,jce1,jce2,ice1,ice2)

      call grid_collect(solis,solis_io,jce1,jce2,ice1,ice2)
      call grid_collect(solvd,solvd_io,jce1,jce2,ice1,ice2)
      call grid_collect(sabveg,sabveg_io,jce1,jce2,ice1,ice2)
      call grid_collect(flw,flw_io,jce1,jce2,ice1,ice2)
      call grid_collect(flwd,flwd_io,jce1,jce2,ice1,ice2)
      call grid_collect(fsw,fsw_io,jce1,jce2,ice1,ice2)
      call grid_collect(sinc,sinc_io,jce1,jce2,ice1,ice2)
      call grid_collect(ldmsk,ldmsk_io,jce1,jce2,ice1,ice2)
#ifndef CLM
      if ( lakemod == 1 ) then
        call subgrid_collect(eta,eta_io,jce1,jce2,ice1,ice2)
...
#endif
      if ( idcsst == 1 ) then
        call grid_collect(dtskin,dtskin_io,jce1,jce2,ice1,ice2)
        call grid_collect(deltas,deltas_io,jce1,jce2,ice1,ice2)
        call grid_collect(tdeltas,tdeltas_io,jce1,jce2,ice1,ice2)
      end if
      ...
      if ( ichem == 1 ) then
        ...
        call grid_collect(ssw2da,ssw2da_io,jce1,jce2,ice1,ice2)
        call grid_collect(sdeltk2d,sdeltk2d_io,jce1,jce2,ice1,ice2)
        call grid_collect(sdelqk2d,sdelqk2d_io,jce1,jce2,ice1,ice2)
        call grid_collect(sfracv2d,sfracv2d_io,jce1,jce2,ice1,ice2)
        call grid_collect(sfracb2d,sfracb2d_io,jce1,jce2,ice1,ice2)
        call grid_collect(sfracs2d,sfracs2d_io,jce1,jce2,ice1,ice2)
        call grid_collect(svegfrac2d,svegfrac2d_io,jce1,jce2,ice1,ice2)
      end if
