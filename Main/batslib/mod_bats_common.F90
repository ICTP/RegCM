...
!
  ...
  contains
    ...
    ps_o(jce1:,ici1:) => fbat(:,:,1)
    u10m_o(jce1:,ici1:) => fbat(:,:,2)
    v10m_o(jce1:,ici1:) => fbat(:,:,3)
    drag_o(jce1:,ici1:) => fbat(:,:,4)
    tg_o(jce1:,ici1:) => fbat(:,:,5)
    tlef_o(jce1:,ici1:) => fbat(:,:,6)
    t2m_o(jce1:,ici1:) => fbat(:,:,7)
    q2m_o(jce1:,ici1:) => fbat(:,:,8)
    ssw_o(jce1:,ici1:) => fbat(:,:,9)
    rsw_o(jce1:,ici1:) => fbat(:,:,10)
    tpr_o(jce1:,ici1:) => fbat(:,:,11)
    evpa_o(jce1:,ici1:) => fbat(:,:,12)
    rnos_o(jce1:,ici1:) => fbat(:,:,13)
    scv_o(jce1:,ici1:) => fbat(:,:,14)
    sena_o(jce1:,ici1:) => fbat(:,:,15)
    flwa_o(jce1:,ici1:) => fbat(:,:,16)
    fswa_o(jce1:,ici1:) => fbat(:,:,17)
    flwd_o(jce1:,ici1:) => fbat(:,:,18)
    sina_o(jce1:,ici1:) => fbat(:,:,19)
    prcv_o(jce1:,ici1:) => fbat(:,:,20)
    zpbl_o(jce1:,ici1:) => fbat(:,:,21)
    aldirs_o(jce1:,ici1:) => fbat(:,:,22)
    aldifs_o(jce1:,ici1:) => fbat(:,:,23)
    sunt_o(jce1:,ici1:) => fbat(:,:,24)
    tgmx_o(jce1:,ici1:) => fbat(:,:,25)
    tgmn_o(jce1:,ici1:) => fbat(:,:,26)
    t2mx_o(jce1:,ici1:) => fbat(:,:,27)
    t2mn_o(jce1:,ici1:) => fbat(:,:,28)
    tavg_o(jce1:,ici1:) => fbat(:,:,29)
    w10x_o(jce1:,ici1:) => fbat(:,:,30)
    pcpx_o(jce1:,ici1:) => fbat(:,:,31)
    pcpa_o(jce1:,ici1:) => fbat(:,:,32)
    sund_o(jce1:,ici1:) => fbat(:,:,33)
    psmn_o(jce1:,ici1:) => fbat(:,:,34)

    call getmem4d(fsub,1,nnsg,jce1,jce2,ici1,ici2,1,numsub,'bats:fsub')
    ps_s(1:,jce1:,ici1:)   => fsub(:,:,:,1)
    u10m_s(1:,jce1:,ici1:) => fsub(:,:,:,2)
    v10m_s(1:,jce1:,ici1:) => fsub(:,:,:,3)
    drag_s(1:,jce1:,ici1:) => fsub(:,:,:,4)
    tg_s(1:,jce1:,ici1:)   => fsub(:,:,:,5)
    tlef_s(1:,jce1:,ici1:) => fsub(:,:,:,6)
    t2m_s(1:,jce1:,ici1:)  => fsub(:,:,:,7)
    q2m_s(1:,jce1:,ici1:)  => fsub(:,:,:,8)
    ssw_s(1:,jce1:,ici1:)  => fsub(:,:,:,9)
    rsw_s(1:,jce1:,ici1:)  => fsub(:,:,:,10)
    tpr_s(1:,jce1:,ici1:)  => fsub(:,:,:,11)
    evpa_s(1:,jce1:,ici1:) => fsub(:,:,:,12)
    rnos_s(1:,jce1:,ici1:) => fsub(:,:,:,13)
    scv_s(1:,jce1:,ici1:)  => fsub(:,:,:,14)
    sena_s(1:,jce1:,ici1:) => fsub(:,:,:,15)
    prcv_s(1:,jce1:,ici1:) => fsub(:,:,:,16)
!
    if ( lakemod == 1 ) then
