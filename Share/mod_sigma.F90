  ...
  contains
    ...
    subroutine init_sigma(nk,dmax,dmin)
      ...
      if ( nk == 14 ) then      ! RegCM2
        ...
        sigma_coordinate(27) = 0.960_rkx
        sigma_coordinate(28) = 0.970_rkx
        sigma_coordinate(29) = 0.980_rkx
        sigma_coordinate(30) = 0.990_rkx
        sigma_coordinate(31) = 1.000_rkx
      else if ( nk == 40 ) then ! RegCM HR
        sigma_coordinate(1) = 0.000_rkx
        sigma_coordinate(2) = 0.025_rkx
        sigma_coordinate(3) = 0.050_rkx
        sigma_coordinate(4) = 0.075_rkx
        ...
        sigma_coordinate(8) = 0.175_rkx
        sigma_coordinate(9) = 0.200_rkx
        sigma_coordinate(10) = 0.225_rkx
        sigma_coordinate(11) = 0.250_rkx
        sigma_coordinate(12) = 0.275_rkx
        sigma_coordinate(13) = 0.300_rkx
        sigma_coordinate(14) = 0.350_rkx
        sigma_coordinate(15) = 0.400_rkx
        sigma_coordinate(16) = 0.450_rkx
        sigma_coordinate(17) = 0.500_rkx
        sigma_coordinate(18) = 0.550_rkx
        sigma_coordinate(19) = 0.600_rkx
        sigma_coordinate(20) = 0.625_rkx
        sigma_coordinate(21) = 0.650_rkx
        sigma_coordinate(22) = 0.675_rkx
        sigma_coordinate(23) = 0.700_rkx
        sigma_coordinate(24) = 0.725_rkx
        sigma_coordinate(25) = 0.750_rkx
        sigma_coordinate(26) = 0.775_rkx
        sigma_coordinate(27) = 0.800_rkx
        sigma_coordinate(28) = 0.825_rkx
        sigma_coordinate(29) = 0.850_rkx
        sigma_coordinate(30) = 0.875_rkx
        sigma_coordinate(31) = 0.900_rkx
        sigma_coordinate(32) = 0.910_rkx
        sigma_coordinate(33) = 0.920_rkx
        sigma_coordinate(34) = 0.930_rkx
        sigma_coordinate(35) = 0.940_rkx
        sigma_coordinate(36) = 0.950_rkx
        sigma_coordinate(37) = 0.960_rkx
        sigma_coordinate(38) = 0.970_rkx
        sigma_coordinate(39) = 0.980_rkx
        sigma_coordinate(40) = 0.990_rkx
        sigma_coordinate(41) = 1.000_rkx
