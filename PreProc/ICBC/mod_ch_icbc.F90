...
chv4(:,:,:,cb_PAR)   = (3*chv4_1(:,:,:,mz_C3H8)+4*chv4_1(:,:,:,mz_BIGALK)+chv4_1(:,:,:,mz_C3H6)+chv4_1(:,:,:,mz_BIGENE))*w_par/amd
...
chv4(:,:,:,cb_ISOPRD)= (chv4_1(:,:,:,mz_MVK)+chv4_1(:,:,:,mz_MACR)+chv4_1(:,:,:,mz_HYDRALD))*w_isoprd/amd
chv4(:,:,:,cb_ONIT)  = (chv4_1(:,:,:,mz_ONIT)+chv4_1(:,:,:,mz_ONITR))*w_onit/amd
chv4(:,:,:,cb_MGLY)  = chv4_1(:,:,:,mz_CH3COCHO)*w_mgly/amd
chv4(:,:,:,cb_AONE)  = (chv4_1(:,:,:,mz_CH3COCH3)+chv4_1(:,:,:,mz_HYAC)+chv4_1(:,:,:,mz_MEK))*w_aone/amd
...
chv4(:,:,:,cb_ALD2)  = (chv4_1(:,:,:,mz_CH3CHO)+chv4_1(:,:,:,mz_GLYALD))*w_ald2/amd
...
!         write(*,*)chfilename
  ...
  subroutine readmz4(idate,idate0,chfilename)
    implicit none
