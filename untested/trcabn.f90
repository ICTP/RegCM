...
!
      integer :: k2 , kn
      real(8) , dimension(ixm1) :: abstrc , dw , pnew , tco2 , th2o ,  &
                                  & to3 , up2
      real(8) , dimension(14,ixm1,4) :: bplnk
      real(8) , dimension(ixm1,4) :: pinpl , tbar , uinpl , winpl
      real(8) , dimension(ixm1,kxp1) :: s2c , ucfc11 , ucfc12 , uch4 ,&
...
!
      ...
      real(8) :: acfc1 , acfc2 , acfc3 , acfc4 , acfc5 , acfc6 , acfc7 ,&
               ...
               & tch4 , tlw , u , w1
      real(8) , dimension(ixm1) :: ds2c , duptyp , rsqti , sqti , tt
      real(8) :: func
      integer :: i , l
