...
\begin{Verbatim}
 ...
 enable_rad_vars = 21*.true., ! Mask to eventually disable variables STS
 enable_sub_vars = 18*.true., ! Mask to eventually disable variables LAK
 enable_sts_vars = 15*.true., ! Mask to eventually disable variables SUB
 enable_lak_vars = 19*.true., ! Mask to eventually disable variables RAD
...
\begin{Verbatim}
 ...
 epmax = 0.999,       ! Maximum precipitation efficiency
 /
