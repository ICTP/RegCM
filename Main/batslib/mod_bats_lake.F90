...
!
  subroutine allocate_mod_bats_lake(ilake)
    ...
    if ( ilake == 1 ) then
      ...
      call getmem3d(idep2d,1,nnsg,1,iym1,1,jxp,'mod_lake:idep2d')
      call getmem3d(eta2d,1,nnsg,1,iym1,1,jxp,'mod_lake:eta2d')
      call getmem3d(hi2d,1,nnsg,1,iym1,1,jxp,'mod_lake:hi2d')
      call getmem3d(aveice2d,1,nnsg,1,iym1,1,jxp,'mod_lake:aveice2d')
      call getmem3d(hsnow2d,1,nnsg,1,iym1,1,jxp,'mod_lake:hsnow2d')
      call getmem4d(tlak3d,1,ndpmax,1,nnsg,1,iym1,1,jxp,'mod_lake:tlak3d')
    end if
