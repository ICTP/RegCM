...
other components. This can be used for setting up a coupling experiment with
...
The \verb=OASIS= configuration requires a separate entries in the namelist input
file.
