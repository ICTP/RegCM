...
module mod_wrtoxd
  ...
  real(sp) , allocatable , dimension(:,:,:) :: oh4 , ho24 , o34 , no34 , h2o24
...
!
    ...
    istatus = nf90_def_var(ncid, 'ho2', nf90_float, x3ddim, ivar(3))
    ...
    istatus = nf90_def_var(ncid, 'o3', nf90_float, x3ddim, ivar(4))
    ...
    istatus = nf90_def_var(ncid, 'no3', nf90_float, x3ddim, ivar(5))
    ...
    istatus = nf90_def_var(ncid, 'h2o2', nf90_float, x3ddim, ivar(6))
