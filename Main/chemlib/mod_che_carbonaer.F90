...
module mod_che_carbonaer
  ...
  real(rkx), pointer, contiguous, dimension(:,:,:) :: ncon
  real(rkx), pointer, contiguous, dimension(:,:,:,:) :: save_chagct
  real(rkx), pointer, contiguous, dimension(:,:,:,:) :: save_ncon
  ! variable for surface area of aerosol
  real(rkx), pointer, contiguous, dimension(:,:,:) :: surf
  real(rkx), pointer, contiguous, dimension(:,:,:) :: so4chagct
  ...
  real(rkx), pointer, contiguous, dimension(:,:,:,:) :: pp
