...
module mod_update
  ...
  subroutine RCM_Allocate()
    ...
    !-----------------------------------------------------------------------
    !
    call getmem(exportFields%psfc,jce1,jce2,ice1,ice2,'cpl:psfc')
    call getmem(exportFields%tsfc,jce1,jce2,ice1,ice2,'cpl:tsfc')
    call getmem(exportFields%qsfc,jce1,jce2,ice1,ice2,'cpl:qsfc')
    call getmem(exportFields%swrd,jce1,jce2,ice1,ice2,'cpl:swrd')
    call getmem(exportFields%lwrd,jce1,jce2,ice1,ice2,'cpl:lwrd')
    call getmem(exportFields%dlwr,jce1,jce2,ice1,ice2,'cpl:dlwr')
    call getmem(exportFields%lhfx,jce1,jce2,ice1,ice2,'cpl:lhfx')
    call getmem(exportFields%shfx,jce1,jce2,ice1,ice2,'cpl:shfx')
    call getmem(exportFields%prec,jce1,jce2,ice1,ice2,'cpl:prec')
    call getmem(exportFields%evap,jce1,jce2,ice1,ice2,'cpl:evap')
    call getmem(exportFields%wndu,jce1,jce2,ice1,ice2,'cpl:wndu')
    call getmem(exportFields%wndv,jce1,jce2,ice1,ice2,'cpl:wndv')
    call getmem(exportFields%rnof,jci1,jci2,ici1,ici2,'cpl:rnof')
    call getmem(exportFields%taux,jce1,jce2,ice1,ice2,'cpl:taux')
    call getmem(exportFields%tauy,jce1,jce2,ice1,ice2,'cpl:tauy')
    call getmem(exportFields%wspd,jce1,jce2,ice1,ice2,'cpl:wspd')
    call getmem(exportFields%wdir,jce1,jce2,ice1,ice2,'cpl:wdir')
    call getmem(exportFields%ustr,jce1,jce2,ice1,ice2,'cpl:ustr')
    call getmem(exportFields%nflx,jce1,jce2,ice1,ice2,'cpl:nflx')
    call getmem(exportFields%sflx,jce1,jce2,ice1,ice2,'cpl:sflx')
    call getmem(exportFields%snow,jce1,jce2,ice1,ice2,'cpl:snow')
    call getmem(exportFields%dswr,jce1,jce2,ice1,ice2,'cpl:dswr')
    call getmem(exportFields%rhoa,jce1,jce2,ice1,ice2,'cpl:rhoa')

    call getmem(importFields%sst,jce1,jce2,ice1,ice2,'cpl:sst')
    call getmem(importFields%sit,jce1,jce2,ice1,ice2,'cpl:sit')
    call getmem(importFields%msk,jce1,jce2,ice1,ice2,'cpl:msk')
    call getmem(importFields%zo,jce1,jce2,ice1,ice2,'cpl:zo')
    call getmem(importFields%ustar,jce1,jce2,ice1,ice2,'cpl:ustar')

    call getmem(ldmskb,jci1,jci2,ici1,ici2,'cpl:ldmsk')
    call getmem(wetdry,jci1,jci2,ici1,ici2,'cpl:wetdry')

    if ( icopcpl == 1 ) then
      call getmem(exportFields3d%u,jce1,jce2,ice1,ice2,1,kz,'cpl:u')
      call getmem(exportFields3d%v,jce1,jce2,ice1,ice2,1,kz,'cpl:v')
      call getmem(exportFields3d%w,jce1,jce2,ice1,ice2,1,kz,'cpl:w')
      call getmem(exportFields3d%t,jce1,jce2,ice1,ice2,1,kz,'cpl:t')
      call getmem(exportFields3d%q,jce1,jce2,ice1,ice2,1,kz,'cpl:q')
      call getmem(exportFields3d%cldfrc,jce1,jce2,ice1,ice2,1,kz,'cpl:cldfrc')
      call getmem(exportFields3d%cldlwc,jce1,jce2,ice1,ice2,1,kz,'cpl:cldlwc')
    end if
    !
    ! Initialize arrays
    !
