...
!
    ...
    qck1oce   = 0.00030D0 ! Autoconversion Rate for Ocean
    ...
    rh0land   = 0.90D0    ! Relative humidity threshold for land
    rh0oce    = 0.95D0    ! Relative humidity threshold for ocean
    ...
    caccroce  = 2.0D0     ! Raindrop accretion rate ocean [m3/kg/s]
    ...
    conf      = 0.90D0    ! Condensation efficiency
