...
!-----------------------------------------------------------------------
   ...
   call CNSetCcs(num_specialc, specialc, 0.D0, clm3%g%l%c%ccs)
   call CNSetCns(num_specialc, specialc, 0.D0, clm3%g%l%c%cns)
   call CNSetCcf(num_specialc, specialc, 0.D0, clm3%g%l%c%ccf)
   call CNSetCnf(num_specialc, specialc, 0.D0, clm3%g%l%c%cnf)

   if ( use_c13 ) then
      call CNSetCcs(num_specialc, specialc, 0.D0, clm3%g%l%c%cc13s)
      call CNSetCcf(num_specialc, specialc, 0.D0, clm3%g%l%c%cc13f)
   endif

   if ( use_c14 ) then
      call CNSetCcs(num_specialc, specialc, 0.D0, clm3%g%l%c%cc14s)
      call CNSetCcf(num_specialc, specialc, 0.D0, clm3%g%l%c%cc14f)
   endif

   ! initialize column-average pft fields
   call CNSetPps(num_specialc, specialc, spval, clm3%g%l%c%cps%pps_a)
   call CNSetPcs(num_specialc, specialc, 0.D0, clm3%g%l%c%ccs%pcs_a)
   call CNSetPns(num_specialc, specialc, 0.D0, clm3%g%l%c%cns%pns_a)
   call CNSetPcf(num_specialc, specialc, 0.D0, clm3%g%l%c%ccf%pcf_a)
   call CNSetPnf(num_specialc, specialc, 0.D0, clm3%g%l%c%cnf%pnf_a)
   ...
   call CNSetPcs(num_specialp, specialp, 0.D0, clm3%g%l%c%p%pcs)
   call CNSetPns(num_specialp, specialp, 0.D0, clm3%g%l%c%p%pns)
   call CNSetPcf(num_specialp, specialp, 0.D0, clm3%g%l%c%p%pcf)
   call CNSetPnf(num_specialp, specialp, 0.D0, clm3%g%l%c%p%pnf)

   if ( use_c13 ) then
      call CNSetPcs(num_specialp, specialp, 0.D0, clm3%g%l%c%p%pc13s)
      call CNSetPcf(num_specialp, specialp, 0.D0, clm3%g%l%c%p%pc13f)
   endif

   if ( use_c14 ) then
      call CNSetPcs(num_specialp, specialp, 0.D0, clm3%g%l%c%p%pc14s)
      call CNSetPcf(num_specialp, specialp, 0.D0, clm3%g%l%c%p%pc14f)
   endif
   ...
   do fc = 1,num_specialc
      ...
      clm3%g%l%c%ccf%lf_conv_cflux(c) = 0.D0    ! F. Li and S. Levis
      ...
      clm3%g%l%c%ccf%landuseflux(c) = 0.D0
      clm3%g%l%c%ccf%landuptake(c) = 0.D0
