...
!     PRINT *,'WRITING OUTPUT:  IDATE= ',IDATE
      ...
      noutrec = noutrec + 1
      write (64,rec=noutrec) ((ps4(i,j)+ptop,i=1,jx),j=1,ix)
      noutrec = noutrec + 1
...
!
      ...
      character(4) :: lsmtyp
      real :: ptop
      real , dimension(jx,ix,4) :: qs3 , ti3 , ts3
      real , dimension(jx,ix) :: snow
...
!
      ...
      if ( lsmtyp=='USGS' ) then
        do k = 1 , 4
          noutrec = noutrec + 1
          write (64,rec=noutrec) ((qs3(i,j,k),i=1,jx),j=1,ix)
        end do
        do k = 1 , 4
          noutrec = noutrec + 1
          write (64,rec=noutrec) ((ti3(i,j,k),i=1,jx),j=1,ix)
        end do
        do k = 1 , 4
          noutrec = noutrec + 1
          write (64,rec=noutrec) ((ts3(i,j,k),i=1,jx),j=1,ix)
        end do
        noutrec = noutrec + 1
        write (64,rec=noutrec) ((snow(i,j),i=1,jx),j=1,ix)
      end if
!
