...
!
   ...
   real(rk8), pointer :: tempsum_npp(:)           ! temporary sum NPP (gC/m2/yr)
   real(rk8), pointer :: annsum_npp(:)            ! annual sum NPP (gC/m2/yr)
   real(rk8), pointer :: cannsum_npp(:)           ! column annual sum NPP (gC/m2/yr)
   real(rk8), pointer :: cannavg_t2m(:)    !annual average of 2m air temperature, averaged from pft-level (K)
#if (defined CNDV)
   real(rk8), pointer :: tempsum_litfall(:)       ! temporary sum litfall (gC/m2/yr)
