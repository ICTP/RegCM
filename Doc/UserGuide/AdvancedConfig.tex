...
!
 ...
 enable_srf_vars = 44*.true., ! Mask to eventually disable variables SRF
...
!
 ...
 t_extrema = 8.0, ! Maximum gradient of T in K for advection to stop
 q_rel_extrema = 0.5, ! Maximum gradient fraction for QV for advection to stop
 c_rel_extrema = 0.8, ! Maximum gradient fraction for QX for advection to stop
 t_rel_extrema = 0.8, ! Maximum gradient fraction for tracer advection to stop
 /
\end{Verbatim}
}
...
\begin{Verbatim}
 ...
 skbmax = 0.1,       ! Max cloud base height in sigma
