...
program interpinic
  ...
  call getmem(i_grid1d_lon,1,ingc,'interpinic:i_grid1d_lon')
  call getmem(i_grid1d_lat,1,ingc,'interpinic:i_grid1d_lat')
  call getmem(i_gval,1,ingc,'interpinic:i_gval')
  call getmem(i_pft1d_lon,1,inpft,'interpinic:i_pft1d_lon')
  call getmem(i_pft1d_lat,1,inpft,'interpinic:i_pft1d_lat')
  call getmem(i_col1d_lon,1,inco,'interpinic:i_col1d_lon')
  call getmem(i_col1d_lat,1,inco,'interpinic:i_col1d_lat')
  call getmem(i_pval,1,inpft,'interpinic:i_pval')
  call getmem(i_cval,1,inco,'interpinic:i_cval')
  call getmem(i_cval_ng,1,ingrd,1,inco,'interpinic:i_cval_ng')
  call getmem(i_cval_ng_t,1,inco,1,ingrd,'interpinic:i_cval_ng_t')
  call getmem(i_ctype,1,inco,'interpinic:i_ctype')
  call getmem(i_ltype,1,inpft,'interpinic:i_ltype')
  call getmem(i_vtype,1,inpft,'interpinic:i_vtype')
  call getmem(o_grid1d_lon,1,ongc,'interpinic:o_grid1d_lon')
  call getmem(o_grid1d_lat,1,ongc,'interpinic:o_grid1d_lat')
  call getmem(o_gval,1,ongc,'interpinic:o_gval')
  call getmem(o_pft1d_lon,1,onpft,'interpinic:o_pft1d_lon')
  call getmem(o_pft1d_lat,1,onpft,'interpinic:o_pft1d_lat')
  call getmem(o_col1d_lon,1,onco,'interpinic:o_col1d_lon')
  call getmem(o_col1d_lat,1,onco,'interpinic:o_col1d_lat')
  call getmem(o_pfts1d_wtxy,1,onpft,'interpinic:o_pfts1d_wtxy')
  call getmem(o_cols1d_wtxy,1,onco,'interpinic:o_cols1d_wtxy')
  call getmem(o_pval,1,onpft,'interpinic:o_pval')
  call getmem(o_cval,1,onco,'interpinic:o_cval')
  call getmem(o_cval_ng,1,ongrd,1,onco,'interpinic:o_cval_ng')
  call getmem(o_cval_ng_t,1,onco,1,ongrd,'interpinic:o_cval_ng_t')
  call getmem(o_ctype,1,onco,'interpinic:o_ctype')
  call getmem(o_ltype,1,onpft,'interpinic:o_ltype')
  call getmem(o_vtype,1,onpft,'interpinic:o_vtype')
  ...
  call getmem(i_mapf,1,ingc,1,imaxpft,'interpinic:i_mapf')
  call getmem(o_mapf,1,ongc,1,omaxpft,'interpinic:o_mapf')
  call getmem(i_mapc,1,ingc,1,maxcol,'interpinic:i_mapc')
  call getmem(o_mapc,1,ongc,1,maxcol,'interpinic:o_mapc')
  ...
  subroutine set_colvals(c1,c2,cv)
    ...
    call getmem(cv,1,ic,'set_colvals:cv')
    cv(:) = ival(1:ic)
