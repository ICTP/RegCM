...
module mod_savefile
  ...
  subroutine allocate_mod_savefile
    ...
    if ( do_parallel_save ) then
      if ( idynamic == 3 ) then
        call getmem(atm_u_io,jde1,jde2,ice1,ice2,1,kz,'atm_u_io')
        call getmem(atm_v_io,jce1,jce2,ide1,ide2,1,kz,'atm_v_io')
        call getmem(atm_t_io,jce1,jce2,ice1,ice2,1,kz,'atm_t_io')
        call getmem(atm_pai_io,jce1,jce2,ice1,ice2,1,kz,'atm_pai_io')
        call getmem(atm_w_io,jce1,jce2,ice1,ice2,1,kzp1,'atm_w_io')
        call getmem(atm_qx_io,jce1,jce2,ice1,ice2,1,kz,1,nqx,'atm_qx_io')
        if ( ibltyp == 2 ) then
          call getmem(atm_tke_io,jce1,jce2,ice1,ice2,1,kzp1,'atm_tke_io')
        end if
        call getmem(ps_io,jce1,jce2,ice1,ice2,'ps_io')
      else
        call getmem(atm1_u_io,jde1,jde2,ide1,ide2,1,kz,'atm1_u_io')
        call getmem(atm1_v_io,jde1,jde2,ide1,ide2,1,kz,'atm1_v_io')
        call getmem(atm1_t_io,jce1,jce2,ice1,ice2,1,kz,'atm1_t_io')
        call getmem(atm1_qx_io,jce1,jce2,ice1,ice2,1,kz,1,nqx,'atm1_qx_io')
        call getmem(atm2_u_io,jde1,jde2,ide1,ide2,1,kz,'atm2_u_io')
        call getmem(atm2_v_io,jde1,jde2,ide1,ide2,1,kz,'atm2_v_io')
        call getmem(atm2_t_io,jce1,jce2,ice1,ice2,1,kz,'atm2_t_io')
        call getmem(atm2_qx_io,jce1,jce2,ice1,ice2,1,kz,1,nqx,'atm2_qx_io')
        if ( ibltyp == 2 ) then
          call getmem(atm1_tke_io,jce1,jce2,ice1,ice2,1,kzp1,'atm1_tke_io')
          call getmem(atm2_tke_io,jce1,jce2,ice1,ice2,1,kzp1,'atm2_tke_io')
        end if
        call getmem(psa_io,jce1,jce2,ice1,ice2,'psa_io')
        call getmem(psb_io,jce1,jce2,ice1,ice2,'psb_io')
      end if
      if ( ibltyp == 4 .or. ibltyp == 5 ) then
        call getmem(tke_pbl_io,jci1,jci2,ici1,ici2,1,kz,'tke_pbl_io')
      end if
      if ( idynamic == 2 ) then
        call getmem(atm1_w_io,jce1,jce2,ice1,ice2,1,kzp1,'atm1_w_io')
        call getmem(atm2_w_io,jce1,jce2,ice1,ice2,1,kzp1,'atm2_w_io')
        call getmem(atm1_pp_io,jce1,jce2,ice1,ice2,1,kz,'atm1_pp_io')
        call getmem(atm2_pp_io,jce1,jce2,ice1,ice2,1,kz,'atm2_pp_io')
      end if

      call getmem(hfx_io,jci1,jci2,ici1,ici2,'hfx_io')
      call getmem(qfx_io,jci1,jci2,ici1,ici2,'qfx_io')
      ...
      call getmem(br_io,jci1,jci2,ici1,ici2,'br_io')
      call getmem(ram_io,jci1,jci2,ici1,ici2,'ram_io')
      call getmem(rah_io,jci1,jci2,ici1,ici2,'rah_io')
      call getmem(ustar_io,jci1,jci2,ici1,ici2,'ustar_io')
      call getmem(zo_io,jci1,jci2,ici1,ici2,'zo_io')
      if ( iocncpl == 1 .or. iwavcpl == 1 ) then
        call getmem(dtrnof_io,jci1,jci2,ici1,ici2,'dtrnof_io')
      end if
#ifdef CLM45
      if ( ichem == 1 ) then
        call getmem(tsoi_io,jci1,jci2,ici1,ici2, &
                            1,num_soil_layers,'tsoi_io')
        call getmem(swvol_io,jci1,jci2,ici1,ici2, &
                            1,num_soil_layers,'swvol_io')
      end if
#else
      call getmem(gwet_io,1,nnsg,jci1,jci2,ici1,ici2,'gwet_io')
      call getmem(ldew_io,1,nnsg,jci1,jci2,ici1,ici2,'ldew_io')
      call getmem(taf_io,1,nnsg,jci1,jci2,ici1,ici2,'taf_io')
#endif
      call getmem(sncv_io,1,nnsg,jci1,jci2,ici1,ici2,'sncv_io')
      call getmem(sfice_io,1,nnsg,jci1,jci2,ici1,ici2,'sfice_io')
      call getmem(snag_io,1,nnsg,jci1,jci2,ici1,ici2,'snag_io')
      call getmem(sw_io,1,nnsg,jci1,jci2,ici1,ici2, &
                          1,num_soil_layers,'sw_io')
      call getmem(tgrd_io,1,nnsg,jci1,jci2,ici1,ici2,'tgrd_io')
      call getmem(tgbrd_io,1,nnsg,jci1,jci2,ici1,ici2,'tgbrd_io')
      call getmem(tlef_io,1,nnsg,jci1,jci2,ici1,ici2,'tlef_io')
      call getmem(emisv_io,1,nnsg,jci1,jci2,ici1,ici2,'emisv_io')
      call getmem(um10_io,1,nnsg,jci1,jci2,ici1,ici2,'um10_io')
      call getmem(ldmsk1_io,1,nnsg,jci1,jci2,ici1,ici2,'ldmsk1')
      call getmem(ldmsk_io,jci1,jci2,ici1,ici2,'ldmsk_io')
      call getmem(flw_io,jci1,jci2,ici1,ici2,'flw_io')
      call getmem(flwd_io,jci1,jci2,ici1,ici2,'flwd_io')
      call getmem(fsw_io,jci1,jci2,ici1,ici2,'fsw_io')
      call getmem(sabveg_io,jci1,jci2,ici1,ici2,'sabveg_io')
      call getmem(totcf_io,jci1,jci2,ici1,ici2,'totcf_io')
      call getmem(sinc_io,jci1,jci2,ici1,ici2,'sinc_io')
      call getmem(solis_io,jci1,jci2,ici1,ici2,'solis_io')
      call getmem(solvs_io,jci1,jci2,ici1,ici2,'solvs_io')
      call getmem(solvsd_io,jci1,jci2,ici1,ici2,'solvsd_io')
      call getmem(solvl_io,jci1,jci2,ici1,ici2,'solvl_io')
      call getmem(solvld_io,jci1,jci2,ici1,ici2,'solvld_io')
      if ( ibltyp == 2 ) then
        call getmem(kpbl_io,jci1,jci2,ici1,ici2,'kpbl_io')
      else if ( ibltyp == 4 ) then
        call getmem(myjsf_uz0_io,jci1,jci2,ici1,ici2,'myjsf_uz0_io')
        call getmem(myjsf_vz0_io,jci1,jci2,ici1,ici2,'myjsf_vz0_io')
        call getmem(myjsf_thz0_io,jci1,jci2,ici1,ici2,'myjsf_thz0_io')
        call getmem(myjsf_qz0_io,jci1,jci2,ici1,ici2,'myjsf_qz0_io')
        call getmem(kpbl_io,jci1,jci2,ici1,ici2,'kpbl_io')
      end if
      if ( idcsst == 1 ) then
        call getmem(sst_io,1,nnsg,jci1,jci2,ici1,ici2,'sst_io')
        call getmem(tskin_io,1,nnsg,jci1,jci2,ici1,ici2,'tskin_io')
        call getmem(deltas_io,1,nnsg,jci1,jci2,ici1,ici2,'deltas_io')
        call getmem(tdeltas_io,1,nnsg,jci1,jci2,ici1,ici2,'tdeltas_io')
      end if
      if ( any(icup == 4) ) then
        call getmem(cbmf2d_io,jci1,jci2,ici1,ici2,'cbmf2d_io')
      end if
      if ( ipptls > 0 ) then
        call getmem(fcc_io,jci1,jci2,ici1,ici2,1,kz,'fcc_io')
      end if

      if ( idynamic == 1 ) then
        call getmem(dstor_io,jde1,jde2,ide1,ide2,1,nsplit,'dstor_io')
        call getmem(hstor_io,jde1,jde2,ide1,ide2,1,nsplit,'hstor_io')
      end if

      if ( irrtm == 0 ) then
        call getmem(gasabsnxt_io,jci1,jci2,ici1,ici2,1,kz,1,4,'gasabsnxt_io')
        call getmem(gasabstot_io,jci1,jci2,ici1,ici2, &
                      1,kzp1,1,kzp1,'gasabstot_io')
        call getmem(gasemstot_io,jci1,jci2,ici1,ici2,1,kzp1,'gasemstot_io')
      end if

      call getmem(cldfra_io,jci1,jci2,ici1,ici2,1,kz,'cldfra_io')
      call getmem(heatrt_io,jci1,jci2,ici1,ici2,1,kz,'heatrt_io')
      call getmem(o3prof_io,jci1,jci2,ici1,ici2,1,kzp1,'o3prof_io')

      if ( islab_ocean == 1 .and. do_restore_sst ) then
        call getmem(qflux_restore_sst_io,jci1,jci2,ici1,ici2, &
                      1,12,'qflux_restore_sst_io')
      end if

      if ( iocnflx == 2 .or. ibltyp == 3 ) then
        call getmem(zpbl_io,jci1,jci2,ici1,ici2,'zpbl_io')
      end if
      if ( any(icup == 3) ) then
        call getmem(cldefi_io,jci1,jci2,ici1,ici2,'cldefi_io')
      end if
      if ( any(icup == 6) .or. any(icup == 5) ) then
        call getmem(cu_avg_ww_io,jci1,jci2,ici1,ici2,1,kz,'cu_avg_ww_io')
      end if
#ifdef CLM
      if ( imask == 2 ) then
        call getmem(lndcat_io,jce1,jce2,ice1,ice2,'lndcat_io')
      end if
#else
      if ( lakemod == 1 ) then
        call getmem(eta_io,1,nnsg,jci1,jci2,ici1,ici2,'eta_io')
        call getmem(hi_io,1,nnsg,jci1,jci2,ici1,ici2,'hi_io')
        call getmem(tlak_io,1,nnsg,jci1,jci2,ici1,ici2,1,ndpmax,'tlak_io')
      end if
#endif
      call getmem(swalb_io,1,nnsg,jci1,jci2,ici1,ici2,'swalb')
      call getmem(lwalb_io,1,nnsg,jci1,jci2,ici1,ici2,'lwalb')
      call getmem(swdiralb_io,1,nnsg,jci1,jci2,ici1,ici2,'swdiralb')
      call getmem(swdifalb_io,1,nnsg,jci1,jci2,ici1,ici2,'swdifalb')
      call getmem(lwdiralb_io,1,nnsg,jci1,jci2,ici1,ici2,'lwdiralb')
      call getmem(lwdifalb_io,1,nnsg,jci1,jci2,ici1,ici2,'lwdifalb')
      return
    else
      if ( myid == iocpu ) then
        if ( idynamic == 3 ) then
          call getmem(atm_u_io,jdot1,jdot2,icross1,icross2,1,kz,'atm_u_io')
          call getmem(atm_v_io,jcross1,jcross2,idot1,idot2,1,kz,'atm_v_io')
          call getmem(atm_t_io,jcross1,jcross2, &
                                 icross1,icross2,1,kz,'atm_t_io')
          call getmem(atm_pai_io,jcross1,jcross2, &
                                   icross1,icross2,1,kz,'atm_pai_io')
          call getmem(atm_w_io,jcross1,jcross2, &
                                 icross1,icross2,1,kzp1,'atm_w_io')
          call getmem(atm_qx_io,jcross1,jcross2, &
                        icross1,icross2,1,kz,1,nqx,'atm_qx_io')
          if ( ibltyp == 2 ) then
            call getmem(atm_tke_io,jcross1,jcross2, &
                          icross1,icross2,1,kzp1,'atm_tke_io')
          end if
          call getmem(ps_io,jcross1,jcross2,icross1,icross2,'ps_io')
        else
          call getmem(atm1_u_io,jdot1,jdot2,idot1,idot2,1,kz,'atm1_u_io')
          call getmem(atm1_v_io,jdot1,jdot2,idot1,idot2,1,kz,'atm1_v_io')
          call getmem(atm1_t_io,jcross1,jcross2, &
                        icross1,icross2,1,kz,'atm1_t_io')
          call getmem(atm1_qx_io,jcross1,jcross2, &
                        icross1,icross2,1,kz,1,nqx,'atm1_qx_io')
          call getmem(atm2_u_io,jdot1,jdot2,idot1,idot2,1,kz,'atm2_u_io')
          call getmem(atm2_v_io,jdot1,jdot2,idot1,idot2,1,kz,'atm2_v_io')
          call getmem(atm2_t_io,jcross1,jcross2, &
                        icross1,icross2,1,kz,'atm2_t_io')
          call getmem(atm2_qx_io,jcross1,jcross2, &
                        icross1,icross2,1,kz,1,nqx,'atm2_qx_io')
          if ( ibltyp == 2 ) then
            call getmem(atm1_tke_io,jcross1,jcross2, &
                          icross1,icross2,1,kzp1,'atm1_tke_io')
            call getmem(atm2_tke_io,jcross1,jcross2, &
                          icross1,icross2,1,kzp1,'atm2_tke_io')
          end if
          call getmem(psa_io,jcross1,jcross2,icross1,icross2,'psa_io')
          call getmem(psb_io,jcross1,jcross2,icross1,icross2,'psb_io')
        end if
        if ( ibltyp == 4 .or. ibltyp == 5 ) then
          call getmem(tke_pbl_io,jcross1,jcross2, &
                        icross1,icross2,1,kz,'tke_pbl_io')
        end if
        if ( idynamic == 2 ) then
          call getmem(atm1_w_io,jcross1,jcross2, &
                        icross1,icross2,1,kzp1,'atm1_w_io')
          call getmem(atm2_w_io,jcross1,jcross2, &
                        icross1,icross2,1,kzp1,'atm2_w_io')
          call getmem(atm1_pp_io,jcross1,jcross2, &
                        icross1,icross2,1,kz,'atm1_pp_io')
          call getmem(atm2_pp_io,jcross1,jcross2, &
                        icross1,icross2,1,kz,'atm2_pp_io')
        end if
        call getmem(hfx_io,jcross1,jcross2,icross1,icross2,'hfx_io')
        call getmem(qfx_io,jcross1,jcross2,icross1,icross2,'qfx_io')
        ...
        call getmem(br_io,jcross1,jcross2,icross1,icross2,'br_io')
        call getmem(ram_io,jcross1,jcross2,icross1,icross2,'ram_io')
        call getmem(rah_io,jcross1,jcross2,icross1,icross2,'rah_io')
        call getmem(ustar_io,jcross1,jcross2,icross1,icross2,'ustar_io')
        call getmem(zo_io,jcross1,jcross2,icross1,icross2,'zo_io')
        if ( iocncpl == 1 .or. iwavcpl == 1 ) then
          call getmem(dtrnof_io,jcross1,jcross2,icross1,icross2,'dtrnof_io')
        end if
#ifdef CLM45
        if ( ichem == 1 ) then
          call getmem(tsoi_io,jcross1,jcross2,icross1,icross2, &
                              1,num_soil_layers,'tsoi_io')
          call getmem(swvol_io,jcross1,jcross2,icross1,icross2, &
                              1,num_soil_layers,'swvol_io')
        end if
#else
        call getmem(gwet_io,1,nnsg,jcross1,jcross2,icross1,icross2,'gwet_io')
        call getmem(ldew_io,1,nnsg,jcross1,jcross2,icross1,icross2,'ldew_io')
        call getmem(taf_io,1,nnsg,jcross1,jcross2,icross1,icross2,'taf_io')
#endif
        call getmem(sncv_io,1,nnsg,jcross1,jcross2,icross1,icross2,'sncv_io')
        call getmem(sfice_io,1,nnsg,jcross1,jcross2, &
                                      icross1,icross2,'sfice_io')
        call getmem(snag_io,1,nnsg,jcross1,jcross2,icross1,icross2,'snag_io')
        call getmem(sw_io,1,nnsg,jcross1,jcross2,icross1,icross2, &
                            1,num_soil_layers,'sw_io')
        call getmem(tgrd_io,1,nnsg,jcross1,jcross2,icross1,icross2,'tgrd_io')
        call getmem(tgbrd_io,1,nnsg,jcross1,jcross2, &
                                      icross1,icross2,'tgbrd_io')
        call getmem(tlef_io,1,nnsg,jcross1,jcross2,icross1,icross2,'tlef_io')
        call getmem(emisv_io,1,nnsg,jcross1,jcross2, &
                                      icross1,icross2,'emisv_io')
        call getmem(um10_io,1,nnsg,jcross1,jcross2,icross1,icross2,'um10_io')
        call getmem(ldmsk1_io,1,nnsg,jcross1,jcross2,icross1,icross2,'ldmsk1')
        call getmem(ldmsk_io,jcross1,jcross2,icross1,icross2,'ldmsk_io')
        call getmem(flw_io,jcross1,jcross2,icross1,icross2,'flw_io')
        call getmem(flwd_io,jcross1,jcross2,icross1,icross2,'flwd_io')
        call getmem(fsw_io,jcross1,jcross2,icross1,icross2,'fsw_io')
        call getmem(sabveg_io,jcross1,jcross2,icross1,icross2,'sabveg_io')
        call getmem(totcf_io,jcross1,jcross2,icross1,icross2,'totcf_io')
        call getmem(sinc_io,jcross1,jcross2,icross1,icross2,'sinc_io')
        call getmem(solis_io,jcross1,jcross2,icross1,icross2,'solis_io')
        call getmem(solvs_io,jcross1,jcross2,icross1,icross2,'solvs_io')
        call getmem(solvsd_io,jcross1,jcross2,icross1,icross2,'solvsd_io')
        call getmem(solvl_io,jcross1,jcross2,icross1,icross2,'solvl_io')
        call getmem(solvld_io,jcross1,jcross2,icross1,icross2,'solvld_io')
        if ( ibltyp == 2 ) then
          call getmem(kpbl_io,jcross1,jcross2,icross1,icross2,'kpbl_io')
        else if ( ibltyp == 4 ) then
          call getmem(myjsf_uz0_io,jcross1,jcross2, &
                                     icross1,icross2,'myjsf_uz0_io')
          call getmem(myjsf_vz0_io,jcross1,jcross2, &
                                     icross1,icross2,'myjsf_vz0_io')
          call getmem(myjsf_thz0_io,jcross1,jcross2, &
                                      icross1,icross2,'myjsf_thz0_io')
          call getmem(myjsf_qz0_io,jcross1,jcross2, &
                                     icross1,icross2,'myjsf_qz0_io')
          call getmem(kpbl_io,jcross1,jcross2,icross1,icross2,'kpbl_io')
        end if
        if ( idcsst == 1 ) then
          call getmem(sst_io,1,nnsg,jcross1,jcross2, &
                                      icross1,icross2,'sst_io')
          call getmem(tskin_io,1,nnsg,jcross1,jcross2, &
                                        icross1,icross2,'tskin_io')
          call getmem(deltas_io,1,nnsg,jcross1,jcross2, &
                                         icross1,icross2,'deltas_io')
          call getmem(tdeltas_io,1,nnsg,jcross1,jcross2, &
                                          icross1,icross2,'tdeltas_io')
        end if

        if ( any(icup == 4) ) then
          call getmem(cbmf2d_io,jcross1,jcross2,icross1,icross2,'cbmf2d_io')
        end if
        if ( ipptls > 0 ) then
          call getmem(fcc_io,jcross1,jcross2,icross1,icross2,1,kz,'fcc_io')
        end if

        if ( idynamic == 1 ) then
          call getmem(dstor_io,jdot1,jdot2,idot1,idot2,1,nsplit,'dstor_io')
          call getmem(hstor_io,jdot1,jdot2,idot1,idot2,1,nsplit,'hstor_io')
        end if

        if ( irrtm == 0 ) then
          call getmem(gasabsnxt_io,jcross1,jcross2, &
                        icross1,icross2,1,kz,1,4,'gasabsnxt_io')
          call getmem(gasabstot_io,jcross1,jcross2, &
                        icross1,icross2,1,kzp1,1,kzp1,'gasabstot_io')
          call getmem(gasemstot_io,jcross1,jcross2, &
                        icross1,icross2,1,kzp1,'gasemstot_io')
        end if

        call getmem(cldfra_io,jcross1,jcross2, &
                      icross1,icross2,1,kz,'cldfra_io')
        call getmem(heatrt_io,jcross1,jcross2, &
                      icross1,icross2,1,kz,'heatrt_io')
        call getmem(o3prof_io,jcross1,jcross2, &
                      icross1,icross2,1,kzp1,'o3prof_io')

        if ( islab_ocean == 1 .and. do_restore_sst ) then
          call getmem(qflux_restore_sst_io,jcross1,jcross2, &
                        icross1,icross2,1,12,'qflux_restore_sst_io')
        end if

        if ( iocnflx == 2 .or. ibltyp == 3 ) then
          call getmem(zpbl_io,jcross1,jcross2,icross1,icross2,'zpbl_io')
        end if
        if ( any(icup == 3) ) then
          call getmem(cldefi_io,jcross1,jcross2,icross1,icross2,'cldefi_io')
        end if
        if ( any(icup == 6) .or. any(icup == 5) ) then
          call getmem(cu_avg_ww_io,jcross1,jcross2, &
                                     icross1,icross2,1,kz,'cu_avg_ww_io')
        end if
#ifdef CLM
        if ( imask == 2 ) then
          call getmem(lndcat_io,jcross1,jcross2,icross1,icross2,'lndcat_io')
        end if
#else
        if ( lakemod == 1 ) then
          call getmem(eta_io,1,nnsg,jcross1,jcross2,icross1,icross2,'eta_io')
          call getmem(hi_io,1,nnsg,jcross1,jcross2,icross1,icross2,'hi_io')
          call getmem(tlak_io,1,nnsg,jcross1,jcross2, &
                                icross1,icross2,1,ndpmax,'tlak_io')
        end if
#endif
        call getmem(swalb_io,1,nnsg,jcross1,jcross2,icross1,icross2,'swalb')
        call getmem(lwalb_io,1,nnsg,jcross1,jcross2,icross1,icross2,'lwalb')
        call getmem(swdiralb_io,1,nnsg,jcross1,jcross2, &
                                         icross1,icross2,'swdiralb')
        call getmem(swdifalb_io,1,nnsg,jcross1,jcross2, &
                                         icross1,icross2,'swdifalb')
        call getmem(lwdiralb_io,1,nnsg,jcross1,jcross2, &
                                         icross1,icross2,'lwdiralb')
        call getmem(lwdifalb_io,1,nnsg,jcross1,jcross2, &
