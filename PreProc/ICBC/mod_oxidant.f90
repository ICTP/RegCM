          ...
          do j = 1 , jx
            do l = 1 , kz
              ...
              if (k0.eq.ilev) then
                ...
                oh4(j,i,l) = oh3(j,i,ilev)                           &
                            +(oh3(j,i,ilev)-oh3(j,i,ilev-1))            &
                            *(prcm-pmpi)/(pmpi-pmpj)
                ho24(j,i,l) = ho23(j,i,ilev)                         &
                             +(ho23(j,i,ilev)-ho23(j,i,ilev-1))         &
                             *(prcm-pmpi)/(pmpi-pmpj)
                o34(j,i,l) = o33(j,i,ilev)                           & 
                            +(o33(j,i,ilev)-o33(j,i,ilev-1))            &
                            *(prcm-pmpi)/(pmpi-pmpj)
                no34(j,i,l) = no33(j,i,ilev)                         &
                             +(no33(j,i,ilev)-no33(j,i,ilev-1))         &
                             *(prcm-pmpi)/(pmpi-pmpj)
                h2o24(j,i,l) = h2o23(j,i,ilev)                       &
                              +(h2o23(j,i,ilev)-h2o23(j,i,ilev-1))      & 
                              *(prcm-pmpi)/(pmpi-pmpj)
