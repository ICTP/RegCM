...
!
      ...
      real(8) , dimension(ix - 1,kx) :: co2eml , pbr , pmln
...
!
      real(8) :: a , a11 , a21 , a22 , a23 , a31 , a41 , a51 , a61 ,    &
               ...
               & ubar , wco2
      real(8) , dimension(ix - 1,6) :: abso
      real(8) , dimension(ix - 1) :: abstrc , dplh2o , dpnm , dtp , dtx ,&
      ...
      real(8) :: dbvt
      real(8) , dimension(ix - 1,kx + 1) :: dbvtit , pnmsq , term6 , term9
      real(8) , dimension(ix - 1,kx) :: dbvtly
      real(8) , dimension(ix - 1,4) :: emm , o3emm , pinpl , tbar ,      &
                                    & temh2o , term1 , term2 , term3 ,  &
                                    & term4 , term5 , uinpl , winpl ,   &
                                    & zinpl
      integer :: i , iband , k , k1 , k2 , kn , wvl
      real(8) , dimension(2) :: r2st
      real(8) , dimension(ix - 1,2) :: term7 , term8 , trline
!
!--------------------------Statement function---------------------------
!
...
!
      ...
      do i = 1 , ix - 1
        dbvtit(i,kx + 1) = dbvt(tint(i,kx + 1))
      end do
!
      r80257 = 1./8.0257D-04
      r293 = 1./293.D0
