    ...
    contains
      ...
      subroutine sound(dts)
        ...
        do jsound = 1 , nsound
          ...
          ud(jde1:jde2,ice1:ice2,1:kz) = u(jde1:jde2,ice1:ice2,1:kz)
          vd(jce1:jce2,ide1:ide2,1:kz) = v(jce1:jce2,ide1:ide2,1:kz)
            ...
            do k = 1 , kz
              do i = ici1 , ici2
                do j = jdi1 , jdi2
                  ...
                  zcor1u = coriol(j,i) * vd(j,i,k) * dts
                  ! Equation 17
            ...
            do k = 1 , kz
              do i = idi1 , idi2
                do j = jci1 , jci2
                  ...
                  zcor1v = coriol(j,i) * ud(j,i,k) * dts
                  ! Equation 18
