module mod_clm_subgridrest
  ...
  subroutine subgridRest( ncid, flag )
    ...
    real(rk8), pointer, contiguous, dimension(:) :: rgarr     ! temporary
    real(rk8), pointer, contiguous, dimension(:) :: rlarr     ! temporary
    real(rk8), pointer, contiguous, dimension(:) :: rcarr     ! temporary
    real(rk8), pointer, contiguous, dimension(:) :: rparr     ! temporary
    integer(ik4), pointer, contiguous, dimension(:) :: igarr  ! temporary
    integer(ik4), pointer, contiguous, dimension(:) :: ilarr  ! temporary
    integer(ik4), pointer, contiguous, dimension(:) :: icarr  ! temporary
