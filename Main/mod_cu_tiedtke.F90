...
!
      use mo_cumulus_flux , only : entrpen , entrscv , lmfdd , cmfdeps ,&
                                 & lmfdudv
      use mod_date , only : fime_step_len
!
      implicit none
!
      integer(in) :: kbdim , klev , klevm1 , klevp1 , kproma , ktrac
...
!
      ...
      real(8) , dimension(kbdim,klev,ktrac) :: pmfdxt , pmfuxt , pxtd , &
           & pxten , pxtenh , pxtu
      intent (in) klevm1 , klevp1 , ktrac , paphp1 , pgeo , pqen ,      &
                & pqsen , pten , ptven , puen , pven , pverv , pxen ,   &
                & pxten
...
!
      ...
      real(8) , dimension(kbdim,klev,ktrac) :: pmfuxt , pxten , pxtenh ,&
           & pxtu
      intent (in) klevm1 , ldland , pcpcu , phcbase , phhatt , pqsenh , &
                & pxtenh
...
!
      ...
      real(8) , dimension(kbdim,klev,ktrac) :: pmfuxt , pxten , pxtenh ,&
           & pxtu
      intent (in) klevm1 , ldland , pcpcu , pxtenh
      intent (out) pqude
...
!
      ...
      implicit none
!
      integer(in) :: kbdim , klev , klevm1 , klevp1 , kproma
      ...
      intent (in) klevm1 , klevp1 , paph , pcpcu , pgeoh , pqenh ,      &
                & ptenh , puen , pven
...
!
      implicit none
!
      integer(in) :: kbdim , kk , klev , kproma , ktrac
      ...
      intent (in) kbdim , kk , klev , kproma , ktrac , ldcum , pcpen ,  &
                & pgeo , pgeoh , pqen , pqsen , pten , puen , pven ,    &
                & pverv , pxten
...
!
      implicit none
!
      integer(in) :: kbdim , klev , klevp1 , kproma , ktrac
      ...
      intent (in) klevp1 , ktrac , lddraf , paphp1 , pcpcu , pgeoh ,    &
                & pqenh , ptenh , puen , pven , pxtenh
      intent (out) pdmfdp
...
!
      ...
      intent (in) kcbot , kctop , klevp1 , ktrac , ldcum , paphp1 ,     &
                & pcpcu , pgeoh , pmfub , pqenh , pqu , ptenh , ptu ,   &
                & puen , puu , pven , pvu , pxtenh , pxtu
...
!
      ...
      use mod_date , only : delta_time
!
      implicit none
!
      integer(in) :: kbdim , klev , klevp1 , kproma , ktopm2 , ktrac
      logical , dimension(kbdim) :: ldcum
      real(8) , dimension(kbdim,klevp1) :: paphp1
      ...
      intent (in) kbdim , klev , klevp1 , kproma , ktopm2 , ktrac ,     &
                & ldcum , paphp1 , pcpen , pdmfdp , pdmfup , pdpmel ,   &
...
!
      implicit none
!
      integer(in) :: kbdim , klev , klevp1 , kproma , ktopm2
      integer , dimension(kbdim) :: kcbot , ktype
      logical , dimension(kbdim) :: ldcum
      real(8) , dimension(kbdim,klevp1) :: paphp1
      real(8) , dimension(kbdim,klev) :: pmfd , pmfu , pud , puen ,     &
           & puu , pvd , pven , pvol , pvom , pvu
      intent (in) kbdim , kcbot , klev , klevp1 , kproma , ktopm2 ,     &
                & ktype , ldcum , paphp1 , pmfd , pmfu , pud , puen ,   &
                & puu , pvd , pven , pvu
...
!
      implicit none
!
      integer(in) :: kbdim , kk , klev , klevp1 , kproma
      ...
      real(8) , dimension(kbdim,klev) :: pgeoh , pmfu , podetr , pqenh ,&
           & pqte , ptenh
      intent (in) kbdim , kcbot , kctop0 , khmin , kk , klev , klevp1 , &
                & klwmin , kproma , ktype , ldcum , paphp1 , pentr ,    &
                & pgeoh , pqenh , pqte , ptenh
...
!
      ...
      intent (in) kbdim , kcbot , kctop0 , kk , klev , klevp1 , klwmin ,&
                & kproma , ktype , ldcum , paphp1 , pentr , pqenh ,     &
                & pqte , ptenh
...
!
      ...
      intent (in) kbdim , kcbot , kctop , kdtop , klev , klevp1 ,       &
                & kproma , ktrac , ldcum , paphp1 , pcpcu , pgeoh ,     &
                & pqen , pqenh , pqsen , pten , ptenh , pxtenh
      intent (out) pdpmel
      intent (inout) ktopm2 , ktype , lddraf , pdmfdp , pdmfup , pmfd , &
                   & pmfdq , pmfds , pmfdxt , pmfu , pmful , pmfuq ,    &
                   & pmfus , pmfuxt , prain , prfl , psfl
!
