...
!
      ...
      namelist /dimparam/ iy,jx,kz,nsg,ntr,ibyte
      ...
      if(day_ICBC) call day2('ICBC',iy,jx,kz,ibyte,idate0,idate1,idate2)
      if(day_ATM)call day('ATM',iy,jx,kz,ntr,ibyte,idate0,idate1,idate2)
      if(day_RAD)call day('RAD',iy,jx,kz,ntr,ibyte,idate0,idate1,idate2)
      if(day_SRF)call day('SRF',iy,jx,kz,ntr,ibyte,idate0,idate1,idate2)
      if(nsg.gt.1.and.day_SUB) &
                call day3('SUB',iy,jx,kz,nsg,ibyte,idate0,idate1,idate2)
      if(day_CHE)call day('CHE',iy,jx,kz,ntr,ibyte,idate0,idate1,idate2)

      if(mon_ICBC) call mon2('ICBC',iy,jx,kz,ibyte,idate0,idate1,idate2)
      if(mon_ATM)call mon('ATM',iy,jx,kz,ntr,ibyte,idate0,idate1,idate2)
      if(mon_RAD)call mon('RAD',iy,jx,kz,ntr,ibyte,idate0,idate1,idate2)
      if(mon_SRF)call mon('SRF',iy,jx,kz,ntr,ibyte,idate0,idate1,idate2)
      if(nsg.gt.1.and.mon_SUB) &
                call mon3('SUB',iy,jx,kz,nsg,ibyte,idate0,idate1,idate2)
      if(mon_CHE)call mon('CHE',iy,jx,kz,ntr,ibyte,idate0,idate1,idate2)

      stop
      end

      subroutine day(filename,iy,jx,kz,ntr,ibyte,idate0,idate1,idate2)
      implicit none
...
!        nvar = ntr*kz+kz*3+ntr*7+2      ! for RegCM3, one record less
      ...
      do nfile=1,n_month
         ...
         inquire(file=fileout//'.ctl',exist=there)
         if(there) then
            open(31,file=fileout//'.ctl',status='replace')
         else
            open(31,file=fileout//'.ctl',status='new')
         endif
         write(31,10) fileout
  10     format('dset ^',A12)
         write(31,20)
 ...
 220  format(10f7.2)
         elseif(iproj.eq.'ROTMER') then
            ...
            write(31,230) jx-2,iy-2,plon,plat,dxsp/111000. &
                                          ,dxsp/111000.*.95238
 ...
 700  format('endvars')
      ...
      subroutine day2(filename,iy,jx,kz,ibyte,idate0,idate1,idate2)
      implicit none
 ...
 700  format('endvars')
      ...
      subroutine day3(filename,iy,jx,kz,nsg,ibyte,idate0,idate1,idate2)
      implicit none
      character*3 filename
 ...
 700  format('endvars')
      ...
      subroutine mon(filename,iy,jx,kz,ntr,ibyte,idate0,idate1,idate2)
      implicit none
      character*3 filename
      integer iy,jx,kz,ntr,ibyte,idate0,idate1,idate2
      integer iiy,jjx,kkz
      ...
      character*12 filein
      character*7 fileout
      integer ntype,nfile,nyear,month,mrec,nrec,nnn
      integer i,j,k,l,m,n,itr
...
!        nvar = ntr*kz+kz*3+ntr*7+2      ! for RegCM3, one record less
 ...
 700  format('endvars')
      ...
      subroutine mon3(filename,iy,jx,kz,nsg,ibyte,idate0,idate1,idate2)
      implicit none
      character*3 filename
      integer iy,jx,kz,nsg,ibyte,idate0,idate1,idate2
      integer iiy,jjx,kkz
 ...
 101  format('DOMAIN.INFO',I1)
 102  format('DOMAIN.INFO',I1)

      open(10,file='OUT_HEAD',form='unformatted' &
             ,recl=(jx-2)*nsg*(iy-2)*nsg*ibyte,access='direct')
      read(10,rec=1) mdate0,ibltyp,icup,ipptls,iboudy  &
                    ,iiy,jjx,kkz,(sigma(k),k=1,kz+1)   &
                    ,dxsp,ptsp,clat,clon,plat,plon     &
                    ,iproj,dto,dtb,dtr,dtc,iotyp,truelatL,truelatH
 ...
 700  format('endvars')
      ...
      subroutine mon2(filename,iy,jx,kz,ibyte,idate0,idate1,idate2)
      implicit none
      character*3 filename
