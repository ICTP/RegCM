...
!
      ...
      else if(i_band.eq.1) then

        if(regDOMAIN) call rgband_DOMAIN(iy,jx,kz,ibyte &
                                      ,Path_Input,DomainName,igrads)

      if(regICBC) call rgband_ICBC(iy,jx,kz,ibyte,idate0,idate1,idate2 &
                                  ,Path_Input,DomainName,igrads)

        if(regICBC_P) call rgband_ICBC_P(iy,jx,kz,np,plev,ibyte  &
                     ,idate0,idate1,idate2,Path_Input,DomainName,igrads)

        if(regOUT_HEAD) call rgband_OUT_HEAD(iy,jx,kz,ibyte &
                                ,Path_Output,igrads)

        if(regATM) call rgband_ATM(iy,jx,kz,ibyte,idate0,idate1,idate2 &
                                ,Path_Output,igrads)

        if(regSRF) call rgband_SRF(iy,jx,kz,ibyte,idate0,idate1,idate2 &
                                ,Path_Output,igrads)

        if(regRAD) call rgband_RAD(iy,jx,kz,ibyte,idate0,idate1,idate2 &
                                ,Path_Output,igrads)

        if(regATM_P) call rgband_ATM_P(iy,jx,kz,np,plev,ibyte  &
                          ,idate0,idate1,idate2,Path_Output,igrads)

      else
        write(*,*) 'i_band should be either 0 or 1'
        stop
      end if
...
!     write(*,*) xminlon,mlon-nlon+1,(nlon-1)*ddeg
 ...
 700  format('endvars')
      ...
      subroutine rgband_DOMAIN(iy,jx,kz,ibyte &
                              ,Path_Input,DomainName,igrads)
      implicit none
      integer iy,jx,kz,ibyte,igrads
      character*128 Path_Input
      ...
      allocate(sigma(kz+1))
      allocate(o(jx+2,iy,9))
      allocate(xlat(jx+2,iy))
      allocate(xlon(jx+2,iy))
      ...
      read(10,rec=5) ((xlat(j,i),j=2,jx+1),i=1,iy)         ! xlat
      do i=1,iy
         xlat(jx+2,i) = xlat(2,i)
         xlat(1,i) = xlat(jx+1,i)
      enddo
      if(size_2d(3).gt.-9990.) then
         xminlat = size_2d(3)
         xmaxlat = size_2d(4)
      ...
      read(10,rec=6) ((xlon(j,i),j=2,jx+1),i=1,iy)         ! xlon
      do i=1,iy
         xlon(jx+2,i) = xlon(2,i) + 360.
         xlon(1,i) = xlon(jx+1,i) - 360.
      enddo
      if(size_2d(1).gt.-9990.) then
         xminlon=size_2d(1)
         xmaxlon=size_2d(2)
...
!     write(*,*) xminlon,mlon-nlon+1,(nlon-1)*ddeg
      ...
      read(10,rec=2)  ((o(j,i,1),j=2,jx+1),i=1,iy)   ! ht
      read(10,rec=5)  ((o(j,i,2),j=2,jx+1),i=1,iy)   ! xlat
      read(10,rec=6)  ((o(j,i,3),j=2,jx+1),i=1,iy)   ! xlon
      read(10,rec=7)  ((o(j,i,4),j=2,jx+1),i=1,iy)   ! dlat
      read(10,rec=8)  ((o(j,i,5),j=2,jx+1),i=1,iy)   ! dlon
      read(10,rec=9)  ((o(j,i,6),j=2,jx+1),i=1,iy)   ! xmap
      read(10,rec=10) ((o(j,i,7),j=2,jx+1),i=1,iy)   ! dmap
      read(10,rec=11) ((o(j,i,8),j=2,jx+1),i=1,iy)   ! coriol
      read(10,rec=13) ((o(j,i,9),j=2,jx+1),i=1,iy)   ! mask
      do l=1,9
      do i=1,iy
         o(jx+2,i,l) = o(2,i,l)
         o(1,i,l) = o(jx+1,i,l)
      ...
      if(iproj.ne.'NORMER') then
         write(*,*) 'For i_band=1, the map projection should be NORMER'
         stop
      endif
      write(*,*)'regrid: NORMER projection, DOMAIN.INFO'
      do l=1,9
 ...
 700  format('endvars')
      ...
      subroutine rgband_OUT_HEAD(iy,jx,kz,ibyte,Path_Output,igrads)
      implicit none
      integer iy,jx,kz,ibyte,igrads
      character*128 Path_Output
      integer iiy,jjx,kkz
      ...
      open(10,file=trim(Path_Output)//'OUT_HEAD',form='unformatted' &
             ,recl=jx*(iy-2)*ibyte,access='direct')
      read(10,rec=1) mdate0,ibltyp,icup,ipptls,iboudy  &
                    ,iiy,jjx,kkz,(sigma(k),k=1,kz+1)   &
                    ,dxsp,ptsp,clat,clon,plat,plon          &
                    ,iproj,dto,dtb,dtr,dtc,iotyp
      ...
      read(10,rec=6) ((xlat(j,i),j=2,jx+1),i=1,iy-2)         ! xlat
      do i=1,iy-2
         xlat(jx+2,i) = xlat(2,i)
         xlat(1,i) = xlat(jx+1,i)
      enddo
      ...
      read(10,rec=7) ((xlon(j,i),j=2,jx+1),i=1,iy-2)         ! xlon
      do i=1,iy-2
         xlon(jx+2,i) = xlon(2,i) + 360.
         xlon(1,i) = xlon(jx+1,i) - 360.
      enddo
...
!     write(*,*) xminlon,mlon-nlon+1,(nlon-1)*ddeg
      ...
      read(10,rec=2)  ((o(j,i,1),j=2,jx+1),i=1,iy-2)   ! ht
      read(10,rec=6)  ((o(j,i,2),j=2,jx+1),i=1,iy-2)   ! xlat
      read(10,rec=7)  ((o(j,i,3),j=2,jx+1),i=1,iy-2)   ! xlon
      read(10,rec=8)  ((o(j,i,4),j=2,jx+1),i=1,iy-2)   ! xmap
      read(10,rec=9)  ((o(j,i,5),j=2,jx+1),i=1,iy-2)   ! dmap
      read(10,rec=10) ((o(j,i,6),j=2,jx+1),i=1,iy-2)   ! coriol
      read(10,rec=11) ((o(j,i,7),j=2,jx+1),i=1,iy-2)   ! mask
      do l=1,7
      do i=1,iy-2
         o(jx+2,i,l) = o(2,i,l)
         o(1,i,l) = o(jx+1,i,l)
 ...
 700  format('endvars')
      ...
      subroutine rgband_ICBC(iy,jx,kz,ibyte,idate0,idate1,idate2 &
                            ,Path_Input,DomainName,igrads)
      implicit none
      integer iy,jx,kz,ibyte,idate0,idate1,idate2,igrads
      character*128 Path_Input
      ...
      allocate(sigma(kz+1))
      allocate(o(jx+2,iy,kz*4+2))
      allocate(xlat(jx+2,iy))
      allocate(xlon(jx+2,iy))
      allocate(dlat(jx+2,iy))
      allocate(dlon(jx+2,iy))
      ...
      read(10,rec=7) ((dlat(j,i),j=2,jx+1),i=1,iy)         ! dlat
      read(10,rec=8) ((dlon(j,i),j=2,jx+1),i=1,iy)         ! dlon
      do i=1,iy
         dlat(jx+2,i) = dlat(2,i)
         dlat(1,i) = dlat(jx+1,i)
      enddo
      do i=1,iy
         dlon(jx+2,i) = dlon(2,i) + 360.
         dlon(1,i) = dlon(jx+1,i) - 360.
      enddo
      close(10)
      ...
      do nfile=1,n_month
         if(ntype.eq.0) then
            ...
            open(10,file= &
                 trim(Path_Input)//trim(DomainName)//'_'//filein(1:12) &
                   ,form='unformatted' &
                   ,recl=(iy-2)*jx*ibyte,access='direct')
            mrec = 0
            open(20,file= &
                trim(Path_Input)//trim(DomainName)//'_'//fileout(1:16) &
                   ,form='unformatted' &
...
!              write(*,*) 'IDATE = ',IDATE
               do l=1,kz*4+2
                  mrec = mrec+1
                  read(10,rec=mrec) ((o(j,i,l),j=2,jx+1),i=1,iy)
               enddo
               do l=1,kz*4+2
               do i=1,iy
                  o(jx+2,i,l) = o(2,i,l)
 ...
 700  format('endvars')
      ...
      subroutine rgband_ICBC_P(iy,jx,kz,np,plev,ibyte  &
                    ,idate0,idate1,idate2,Path_Input,DomainName,igrads)
      implicit none
      integer iy,jx,kz,np,ibyte,idate0,idate1,idate2,igrads
      real*4  plev(np)
...
!     write(*,*) xminlon,mlon-nlon+1,(nlon-1)*ddeg
      ...
      do nfile=1,n_month
         if(ntype.eq.0) then
            ...
            open(10,file= &
                 trim(Path_Input)//trim(DomainName)//'_'//filein  &
          ,form='unformatted',recl=(iy-2)*jx*ibyte,access='direct')
            mrec = 0
            open(20,file= &
                 trim(Path_Input)//trim(DomainName)//'_'//fileout &
                   ,form='unformatted' &
 ...
 700  format('endvars')
      ...
      subroutine rgband_ATM(iy,jx,kz,ibyte,idate0,idate1,idate2 &
                           ,Path_Output,igrads)
      implicit none
      integer iy,jx,kz,ibyte,idate0,idate1,idate2,igrads
      character*128 Path_Output
...
!     write(*,*) xminlon,mlon-nlon+1,(nlon-1)*ddeg
      ...
      do nfile=1,n_month
         ...
         do nnn=1,n_slice
            do l=1,kz*6+5
               mrec = mrec+1
               read(10,rec=mrec) ((o(j,i,l),j=2,jx+1),i=1,iy-2)
            enddo
            do l=1,kz*6+5
            do i=1,iy-2
               o(jx+2,i,l) = o(2,i,l)
 ...
 700  format('endvars')
      ...
      subroutine rgband_ATM_P(iy,jx,kz,np,plev,ibyte  &
                             ,idate0,idate1,idate2,Path_Output,igrads)
      implicit none
      integer iy,jx,kz,np,ibyte,idate0,idate1,idate2,igrads
      real*4  plev(np)
...
!     write(*,*) xminlon,mlon-nlon+1,(nlon-1)*ddeg
 ...
 700  format('endvars')
      ...
      subroutine rgband_SRF(iy,jx,kz,ibyte,idate0,idate1,idate2 &
                           ,Path_Output,igrads)
      implicit none
      integer iy,jx,kz,ibyte,idate0,idate1,idate2,igrads
      character*128 Path_Output
...
!     write(*,*) xminlon,mlon-nlon+1,(nlon-1)*ddeg
 ...
 700  format('endvars')
      ...
      subroutine rgband_RAD(iy,jx,kz,ibyte,idate0,idate1,idate2 &
                           ,Path_Output,igrads)
      implicit none
      integer iy,jx,kz,ibyte,idate0,idate1,idate2,igrads
      character*128 Path_Output
