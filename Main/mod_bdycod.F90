      ...
      do n = iqfrst , iqlst
        do k = 1 , kz
          do i = ice1 , ice2
            ...
            windavg = wue(i,k) + wue(i+1,k) + wui(i,k) + wui(i+1,k)
            if ( windavg >= d_zero ) then
              atm1%qx(jce1,i,k,n) = minqx ! max(minqx,d_half*qxint*sfs%psa(jce1,i))
            else
      ...
      do n = iqfrst , iqlst
        do k = 1 , kz
          do i = ice1 , ice2
            ...
            windavg = eue(i,k) + eue(i+1,k) + eui(i,k) + eui(i+1,k)
            if ( windavg <= d_zero ) then
              atm1%qx(jce2,i,k,n) = minqx ! max(minqx,d_half*qxint*sfs%psa(jce2,i))
            else
      ...
      do n = iqfrst , iqlst
        do k = 1 , kz
          do j = jci1 , jci2
            ...
            windavg = sve(j,k) + sve(j+1,k) + svi(j,k) + svi(j+1,k)
            if ( windavg >= d_zero ) then
              atm1%qx(j,ice1,k,n) = minqx ! max(minqx,d_half*qxint*sfs%psa(j,ice1))
            else
      ...
      do n = iqfrst , iqlst
        do k = 1 , kz
          do j = jci1 , jci2
            ...
            windavg = nve(j,k) + nve(j+1,k) + nvi(j,k) + nvi(j+1,k)
            if ( windavg <= d_zero ) then
              atm1%qx(j,ice2,k,n) = minqx ! max(minqx,d_half*qxint*sfs%psa(j,ice2))
            else
