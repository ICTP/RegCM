module mod_clm_cninispecial
  ...
  subroutine CNiniSpecial ()
    ...
    call CNSetCcs(num_specialc, specialc, 0._rkx, clm3%g%l%c%ccs)
    call CNSetCns(num_specialc, specialc, 0._rkx, clm3%g%l%c%cns)
    call CNSetCcf(num_specialc, specialc, 0._rkx, clm3%g%l%c%ccf)
    call CNSetCnf(num_specialc, specialc, 0._rkx, clm3%g%l%c%cnf)

    if ( use_c13 ) then
      call CNSetCcs(num_specialc, specialc, 0._rkx, clm3%g%l%c%cc13s)
      call CNSetCcf(num_specialc, specialc, 0._rkx, clm3%g%l%c%cc13f)
    end if

    if ( use_c14 ) then
      call CNSetCcs(num_specialc, specialc, 0._rkx, clm3%g%l%c%cc14s)
      call CNSetCcf(num_specialc, specialc, 0._rkx, clm3%g%l%c%cc14f)
    end if

    ! initialize column-average pft fields
    call CNSetPps(num_specialc, specialc, spval, clm3%g%l%c%cps%pps_a)
    call CNSetPcs(num_specialc, specialc, 0._rkx, clm3%g%l%c%ccs%pcs_a)
    call CNSetPns(num_specialc, specialc, 0._rkx, clm3%g%l%c%cns%pns_a)
    call CNSetPcf(num_specialc, specialc, 0._rkx, clm3%g%l%c%ccf%pcf_a)
    call CNSetPnf(num_specialc, specialc, 0._rkx, clm3%g%l%c%cnf%pnf_a)
    ...
    call CNSetPcs(num_specialp, specialp, 0._rkx, clm3%g%l%c%p%pcs)
    call CNSetPns(num_specialp, specialp, 0._rkx, clm3%g%l%c%p%pns)
    call CNSetPcf(num_specialp, specialp, 0._rkx, clm3%g%l%c%p%pcf)
    call CNSetPnf(num_specialp, specialp, 0._rkx, clm3%g%l%c%p%pnf)

    if ( use_c13 ) then
      call CNSetPcs(num_specialp, specialp, 0._rkx, clm3%g%l%c%p%pc13s)
      call CNSetPcf(num_specialp, specialp, 0._rkx, clm3%g%l%c%p%pc13f)
    end if

    if ( use_c14 ) then
      call CNSetPcs(num_specialp, specialp, 0._rkx, clm3%g%l%c%p%pc14s)
      call CNSetPcf(num_specialp, specialp, 0._rkx, clm3%g%l%c%p%pc14f)
    end if
    ...
    do fp = 1,num_specialp
      p = specialp(fp)
      clm3%g%l%c%p%pps%tlai(p) = 0._rkx
      clm3%g%l%c%p%pps%tsai(p) = 0._rkx
      clm3%g%l%c%p%pps%elai(p) = 0._rkx
      clm3%g%l%c%p%pps%esai(p) = 0._rkx
      clm3%g%l%c%p%pps%htop(p) = 0._rkx
      clm3%g%l%c%p%pps%hbot(p) = 0._rkx
      clm3%g%l%c%p%pps%fwet(p) = 0._rkx
      clm3%g%l%c%p%pps%fdry(p) = 0._rkx
      clm3%g%l%c%p%pps%frac_veg_nosno_alb(p) = 0
      clm3%g%l%c%p%pps%frac_veg_nosno(p) = 0
      clm3%g%l%c%p%pcf%psnsun(p) = 0._rkx
      clm3%g%l%c%p%pcf%psnsha(p) = 0._rkx
      if (crop_prog) clm3%g%l%c%p%pnf%fert(p)   = 0._rkx
    ...
    do fc = 1,num_specialc
      c = specialc(fc)
      clm3%g%l%c%cwf%qflx_irrig(c) = 0._rkx
      clm3%g%l%c%ccf%pcf_a%psnsun(c) = 0._rkx
      clm3%g%l%c%ccf%pcf_a%psnsha(c) = 0._rkx

      if ( use_c13 ) then
        clm3%g%l%c%cc13f%pcf_a%psnsun(c) = 0._rkx
        clm3%g%l%c%cc13f%pcf_a%psnsha(c) = 0._rkx
      end if

      if ( use_c14 ) then
        clm3%g%l%c%cc14f%pcf_a%psnsun(c) = 0._rkx
        clm3%g%l%c%cc14f%pcf_a%psnsha(c) = 0._rkx
      end if

      ! adding dynpft code
      clm3%g%l%c%ccs%seedc(c) = 0._rkx
      clm3%g%l%c%ccs%prod10c(c) = 0._rkx
      clm3%g%l%c%ccs%prod100c(c) = 0._rkx
      clm3%g%l%c%ccs%totprodc(c) = 0._rkx

      if ( use_c13 ) then
        clm3%g%l%c%cc13s%seedc(c) = 0._rkx
        clm3%g%l%c%cc13s%prod10c(c) = 0._rkx
        clm3%g%l%c%cc13s%prod100c(c) = 0._rkx
        clm3%g%l%c%cc13s%totprodc(c) = 0._rkx
      end if

      if ( use_c14 ) then
        clm3%g%l%c%cc14s%seedc(c) = 0._rkx
        clm3%g%l%c%cc14s%prod10c(c) = 0._rkx
        clm3%g%l%c%cc14s%prod100c(c) = 0._rkx
        clm3%g%l%c%cc14s%totprodc(c) = 0._rkx
      end if

      clm3%g%l%c%cns%seedn(c) = 0._rkx
      clm3%g%l%c%cns%prod10n(c) = 0._rkx
      clm3%g%l%c%cns%prod100n(c) = 0._rkx
      clm3%g%l%c%cns%totprodn(c) = 0._rkx
      ...
      clm3%g%l%c%ccf%lf_conv_cflux(c) = 0._rkx    ! F. Li and S. Levis
      ...
      clm3%g%l%c%ccf%landuseflux(c) = 0._rkx
      clm3%g%l%c%ccf%landuptake(c) = 0._rkx
