...
!         table.
          if ( i == jcld+3 ) then
            if ( iwri >= 1 ) write (58,99014) (jfsur(jc),jc=1,28)
            if ( iwri >= 1 ) write (58,99014) (jfrac(jcld,jc),jc=1,28)
            if ( iwri >= 1 ) write (58,99014) (jfrac(jcld+1,jc),jc=1,28)
            if ( iwri >= 1 ) write (58,99014) (jfrac(jcld+2,jc),jc=1,28)
            if ( iwri >= 1 ) write (58,99014) (jfrac(jcld+3,jc),jc=1,28)
            if ( iwri >= 1 ) write (58,99014) (jval(jc),jc=1,28)
            if ( iwri == 1 ) write (57,99014) (jfsur(jc),jc=1,28)
            if ( iwri == 1 ) write (57,99014) (jfrac(jcld,jc),jc=1,28)
            if ( iwri == 1 ) write (57,99014) (jfrac(jcld+1,jc),jc=1,28)
            if ( iwri == 1 ) write (57,99014) (jfrac(jcld+2,jc),jc=1,28)
            if ( iwri == 1 ) write (57,99014) (jfrac(jcld+3,jc),jc=1,28)
            if ( iwri >= 1 ) write (57,99014) (jval(jc),jc=1,28)
          end if
