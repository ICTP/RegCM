...
! ****************************************************************
      ...
      WRITE(10,999) (TIME-TSTART)/1800.D0,  &
...
! ****************************************************************
      ...
      open(20, file='gasphs.m')
      write(20,*) 'load gasphs.dat;'
      write(20,990) PREFIX
990   FORMAT(A1,'c = gasphs;')
      write(20,*) 'clear gasphs;'
