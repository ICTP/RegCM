...
\begin{Verbatim}
 ...
 mo_cflhmax = 0.6,  ! Safety CFL fraction for computing advection timestep
 mo_cflsmax = 0.25, ! Safety CFL fraction for computing sound waves timestep
 mo_nzfilt = 3,     ! Number of top levels where W filter is active
 mo_anu2 = 0.8,     ! Moloch factor for divergence filtering
 mo_filterpai = .T.,! Filter on Exner function tendencies activated
 /
\end{Verbatim}
}
