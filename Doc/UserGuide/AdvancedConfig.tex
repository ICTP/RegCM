...
\begin{Verbatim}
 ...
 upu = 0.2,              ! Maximum off-centering factor to use
 umax = 200.0,           ! Value of P*U for maximum off centering
...
\begin{Verbatim}
 ...
 bdy_nm = 0.1,  ! Newtonian term, Eq. 7 Giorgi et al, 1993
 bdy_dm = 50.0, ! Diffusion term, Eq. 8 Giorgi et al, 1993 
 /
\end{Verbatim}
}
...
\begin{Verbatim}
 ...
 ifupr = 1,         ! Upper radiative boundary condition (Klemp and Durran,
                    ! Bougeault, 1983)
 ifrayd = 0,        ! Upper levels Rayleigh damper (Klemp 2008, AMS)
 ...
 nhgammr = 0.2,     ! Gammar value in Rayleigh damper (Klemp e Lily 1978)
                    ! range 0.1-0.4 s^-1 (Klemp et al. 2008 -> 0.2)
 nhzetad = 5000.0,  ! Distance from top up to where damper active
 /
\end{Verbatim}
}
