...
\begin{Verbatim}
 ...
 enable_atm_vars = 30*.true., ! Mask to eventually disable variables ATM
 ...
 enable_sts_vars = 15*.true., ! Mask to eventually disable variables STS
...
\begin{Verbatim}
 ...
 ctrigger = 1.0D0,  ! Trigger parameter 0 <- -> 1
