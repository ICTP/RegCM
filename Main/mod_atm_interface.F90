...
module mod_atm_interface
  ...
  contains
    ...
    subroutine allocate_atmosphere(atm)
      ...
      call getmem3d(atm%ux,jce1gb,jce2gb,ice1,ice2,1,kz,'atmstate:ux')
      call getmem3d(atm%vx,jce1,jce2,ice1gb,ice2gb,1,kz,'atmstate:vx')
      ...
      call getmem3d(atm%zeta,jce1ga,jce2ga,ice1ga,ice2ga,1,kz,'atmstate:zeta')
      ...
      call getmem3d(atm%qs,jci1,jci2,ici1,ici2,1,kz,'atmstate:qs')
    ...
    subroutine allocate_slice(ax,a0)
      ...
      if ( idynamic == 3 ) then
        ...
        call getmem3d(ax%th3d,jci1,jci2,ici1,ici2,1,kz,'slice:th3d')
