 ...
 !     netCDF file 'GTOPO30_60MIN.CDF' into memory.
 !  
 !  History: 
 !  Date       Name          Action
 !-------------------------------------------------------
 ...
 !     Below   5 variables is the data in netCDF file
      ...
      real*4         :: lat(          180 )
      real*8         :: time(nrec)
      integer*2      ::  HT( 360, 180,nrec)
      integer*2      ::  HTSD( 360, 180,nrec)
      character*2    ::  a(360,180),char_2
      integer*1      :: I1
 ...
 ! Open netCDF file.
       status=nf_open('GTOPO30_60MIN.CDF',nf_nowrite,ncid)
 ...
 !     Here write your own code please!
       open(20,file='HT_pal.dat',form='unformatted',recl=360*180*2,access='direct')
       do j=1,180
       do i=1,360
